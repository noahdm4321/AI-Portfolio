...
_XlaSparseDenseMatmulCustomCombinerOnTcGradWithAdagradAndCsrInputOutput = collections.namedtuple(
    "XlaSparseDenseMatmulCustomCombinerOnTcGradWithAdagradAndCsrInput",
    ["updated_embedding_table", "updated_accumulator", "updated_weights"])


def xla_sparse_dense_matmul_custom_combiner_on_tc_grad_with_adagrad_and_csr_input(row_pointers: Annotated[Any, _atypes.Int32], sorted_sample_ids: Annotated[Any, _atypes.Int32], sorted_token_ids: Annotated[Any, _atypes.Int32], sorted_pos_ids: Annotated[Any, _atypes.Int32], sorted_gains: Annotated[Any, _atypes.Float32], weights: Annotated[Any, _atypes.Float32], preserved_valencies: Annotated[Any, _atypes.Int32], preserved_vectors: Annotated[Any, _atypes.Float32], preserved_weights: Annotated[Any, _atypes.Float32], activation_gradients: Annotated[Any, _atypes.Float32], learning_rate: Annotated[Any, _atypes.Float32], combiner_weights_learning_rate: Annotated[Any, _atypes.Float32], embedding_table: Annotated[Any, _atypes.Float32], accumulator: Annotated[Any, _atypes.Float32], max_valency: int, num_weights: int, combiner_table_vjp_computation, combiner_weights_vjp_computation, table_name: str, clip_weight_min:float=float('-inf'), clip_weight_max:float=float('inf'), num_sparsecores_per_device:int=-1, name=None):
  r"""TODO: add doc.
  ...
  Args:
    ...
    sorted_sample_ids: A `Tensor` of type `int32`.
    sorted_token_ids: A `Tensor` of type `int32`.
    sorted_pos_ids: A `Tensor` of type `int32`.
    sorted_gains: A `Tensor` of type `float32`.
    weights: A `Tensor` of type `float32`.
    preserved_valencies: A `Tensor` of type `int32`.
    preserved_vectors: A `Tensor` of type `float32`.
    preserved_weights: A `Tensor` of type `float32`.
    activation_gradients: A `Tensor` of type `float32`.
    learning_rate: A `Tensor` of type `float32`.
    combiner_weights_learning_rate: A `Tensor` of type `float32`.
    embedding_table: A `Tensor` of type `float32`.
    accumulator: A `Tensor` of type `float32`.
    max_valency: An `int` that is `>= 0`.
    num_weights: An `int` that is `>= 0`.
    combiner_table_vjp_computation: A function decorated with @Defun.
    combiner_weights_vjp_computation: A function decorated with @Defun.
    table_name: A `string`.
    clip_weight_min: An optional `float`. Defaults to `float('-inf')`.
    clip_weight_max: An optional `float`. Defaults to `float('inf')`.
    num_sparsecores_per_device: An optional `int`. Defaults to `-1`.
    name: A name for the operation (optional).

  Returns:
    A tuple of `Tensor` objects (updated_embedding_table, updated_accumulator, updated_weights).

    updated_embedding_table: A `Tensor` of type `float32`.
    updated_accumulator: A `Tensor` of type `float32`.
    updated_weights: A `Tensor` of type `float32`.
  """
  _ctx = _context._context or _context.context()
  tld = _ctx._thread_local_data
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx,
        "XlaSparseDenseMatmulCustomCombinerOnTcGradWithAdagradAndCsrInput",
        name, row_pointers, sorted_sample_ids, sorted_token_ids,
        sorted_pos_ids, sorted_gains, weights, preserved_valencies,
        preserved_vectors, preserved_weights, activation_gradients,
        learning_rate, combiner_weights_learning_rate, embedding_table,
        accumulator, "clip_weight_min", clip_weight_min, "clip_weight_max",
        clip_weight_max, "max_valency", max_valency, "num_weights",
        num_weights, "combiner_table_vjp_computation",
        combiner_table_vjp_computation, "combiner_weights_vjp_computation",
        combiner_weights_vjp_computation, "table_name", table_name,
        "num_sparsecores_per_device", num_sparsecores_per_device)
      _result = _XlaSparseDenseMatmulCustomCombinerOnTcGradWithAdagradAndCsrInputOutput._make(_result)
      return _result
    except _core._NotOkStatusException as e:
      _ops.raise_from_not_ok_status(e, name)
    except _core._FallbackException:
      pass
    try:
      return xla_sparse_dense_matmul_custom_combiner_on_tc_grad_with_adagrad_and_csr_input_eager_fallback(
          row_pointers, sorted_sample_ids, sorted_token_ids, sorted_pos_ids,
          sorted_gains, weights, preserved_valencies, preserved_vectors,
          preserved_weights, activation_gradients, learning_rate,
          combiner_weights_learning_rate, embedding_table, accumulator,
          clip_weight_min=clip_weight_min, clip_weight_max=clip_weight_max,
          max_valency=max_valency, num_weights=num_weights,
          combiner_table_vjp_computation=combiner_table_vjp_computation,
          combiner_weights_vjp_computation=combiner_weights_vjp_computation,
          table_name=table_name,
          num_sparsecores_per_device=num_sparsecores_per_device, name=name,
          ctx=_ctx)
    except _core._SymbolicException:
      pass  # Add nodes to the TensorFlow graph.
  # Add nodes to the TensorFlow graph.
  max_valency = _execute.make_int(max_valency, "max_valency")
  num_weights = _execute.make_int(num_weights, "num_weights")
  table_name = _execute.make_str(table_name, "table_name")
  ...
  if num_sparsecores_per_device is None:
    num_sparsecores_per_device = -1
  num_sparsecores_per_device = _execute.make_int(num_sparsecores_per_device, "num_sparsecores_per_device")
  _, _, _op, _outputs = _op_def_library._apply_op_helper(
        "XlaSparseDenseMatmulCustomCombinerOnTcGradWithAdagradAndCsrInput", row_pointers=row_pointers,
                                                                            sorted_sample_ids=sorted_sample_ids,
                                                                            sorted_token_ids=sorted_token_ids,
                                                                            sorted_pos_ids=sorted_pos_ids,
                                                                            sorted_gains=sorted_gains,
                                                                            weights=weights,
                                                                            preserved_valencies=preserved_valencies,
                                                                            preserved_vectors=preserved_vectors,
                                                                            preserved_weights=preserved_weights,
                                                                            activation_gradients=activation_gradients,
                                                                            learning_rate=learning_rate,
                                                                            combiner_weights_learning_rate=combiner_weights_learning_rate,
                                                                            embedding_table=embedding_table,
                                                                            accumulator=accumulator,
  ...
  if _execute.must_record_gradient():
    _attrs = ("clip_weight_min", _op.get_attr("clip_weight_min"),
              ...
              "max_valency", _op._get_attr_int("max_valency"), "num_weights",
              _op._get_attr_int("num_weights"),
              "combiner_table_vjp_computation",
              _op.get_attr("combiner_table_vjp_computation"),
              "combiner_weights_vjp_computation",
              _op.get_attr("combiner_weights_vjp_computation"), "table_name",
              _op.get_attr("table_name"), "num_sparsecores_per_device",
              _op._get_attr_int("num_sparsecores_per_device"))
    _inputs_flat = _op.inputs
    _execute.record_gradient(
        "XlaSparseDenseMatmulCustomCombinerOnTcGradWithAdagradAndCsrInput", _inputs_flat, _attrs, _result)
  _result = _XlaSparseDenseMatmulCustomCombinerOnTcGradWithAdagradAndCsrInputOutput._make(_result)
  return _result

XlaSparseDenseMatmulCustomCombinerOnTcGradWithAdagradAndCsrInput = tf_export("raw_ops.XlaSparseDenseMatmulCustomCombinerOnTcGradWithAdagradAndCsrInput")(_ops.to_raw_op(xla_sparse_dense_matmul_custom_combiner_on_tc_grad_with_adagrad_and_csr_input))


def xla_sparse_dense_matmul_custom_combiner_on_tc_grad_with_adagrad_and_csr_input_eager_fallback(row_pointers: Annotated[Any, _atypes.Int32], sorted_sample_ids: Annotated[Any, _atypes.Int32], sorted_token_ids: Annotated[Any, _atypes.Int32], sorted_pos_ids: Annotated[Any, _atypes.Int32], sorted_gains: Annotated[Any, _atypes.Float32], weights: Annotated[Any, _atypes.Float32], preserved_valencies: Annotated[Any, _atypes.Int32], preserved_vectors: Annotated[Any, _atypes.Float32], preserved_weights: Annotated[Any, _atypes.Float32], activation_gradients: Annotated[Any, _atypes.Float32], learning_rate: Annotated[Any, _atypes.Float32], combiner_weights_learning_rate: Annotated[Any, _atypes.Float32], embedding_table: Annotated[Any, _atypes.Float32], accumulator: Annotated[Any, _atypes.Float32], max_valency: int, num_weights: int, combiner_table_vjp_computation, combiner_weights_vjp_computation, table_name: str, clip_weight_min: float, clip_weight_max: float, num_sparsecores_per_device: int, name, ctx):
  max_valency = _execute.make_int(max_valency, "max_valency")
  num_weights = _execute.make_int(num_weights, "num_weights")
  table_name = _execute.make_str(table_name, "table_name")
  if clip_weight_min is None:
  ...
  sorted_pos_ids = _ops.convert_to_tensor(sorted_pos_ids, _dtypes.int32)
  sorted_gains = _ops.convert_to_tensor(sorted_gains, _dtypes.float32)
  weights = _ops.convert_to_tensor(weights, _dtypes.float32)
  preserved_valencies = _ops.convert_to_tensor(preserved_valencies, _dtypes.int32)
  preserved_vectors = _ops.convert_to_tensor(preserved_vectors, _dtypes.float32)
  preserved_weights = _ops.convert_to_tensor(preserved_weights, _dtypes.float32)
  activation_gradients = _ops.convert_to_tensor(activation_gradients, _dtypes.float32)
  learning_rate = _ops.convert_to_tensor(learning_rate, _dtypes.float32)
  combiner_weights_learning_rate = _ops.convert_to_tensor(combiner_weights_learning_rate, _dtypes.float32)
  embedding_table = _ops.convert_to_tensor(embedding_table, _dtypes.float32)
  accumulator = _ops.convert_to_tensor(accumulator, _dtypes.float32)
  _inputs_flat = [row_pointers, sorted_sample_ids, sorted_token_ids, sorted_pos_ids, sorted_gains, weights, preserved_valencies, preserved_vectors, preserved_weights, activation_gradients, learning_rate, combiner_weights_learning_rate, embedding_table, accumulator]
  _attrs = ("clip_weight_min", clip_weight_min, "clip_weight_max",
  clip_weight_max, "max_valency", max_valency, "num_weights", num_weights,
  "combiner_table_vjp_computation", combiner_table_vjp_computation,
  "combiner_weights_vjp_computation", combiner_weights_vjp_computation,
  "table_name", table_name, "num_sparsecores_per_device",
  num_sparsecores_per_device)
  _result = _execute.execute(b"XlaSparseDenseMatmulCustomCombinerOnTcGradWithAdagradAndCsrInput",
...
_XlaSparseDenseMatmulCustomCombinerOnTcGradWithAdagradMomentumAndCsrInputOutput = collections.namedtuple(
    "XlaSparseDenseMatmulCustomCombinerOnTcGradWithAdagradMomentumAndCsrInput",
    ["updated_embedding_table", "updated_accumulator", "updated_momenta", "updated_weights"])


def xla_sparse_dense_matmul_custom_combiner_on_tc_grad_with_adagrad_momentum_and_csr_input(row_pointers: Annotated[Any, _atypes.Int32], sorted_sample_ids: Annotated[Any, _atypes.Int32], sorted_token_ids: Annotated[Any, _atypes.Int32], sorted_pos_ids: Annotated[Any, _atypes.Int32], sorted_gains: Annotated[Any, _atypes.Float32], weights: Annotated[Any, _atypes.Float32], preserved_valencies: Annotated[Any, _atypes.Int32], preserved_vectors: Annotated[Any, _atypes.Float32], preserved_weights: Annotated[Any, _atypes.Float32], activation_gradients: Annotated[Any, _atypes.Float32], learning_rate: Annotated[Any, _atypes.Float32], combiner_weights_learning_rate: Annotated[Any, _atypes.Float32], embedding_table: Annotated[Any, _atypes.Float32], accumulator: Annotated[Any, _atypes.Float32], momenta: Annotated[Any, _atypes.Float32], use_nesterov: bool, exponent: float, beta1: float, beta2: float, epsilon: float, max_valency: int, num_weights: int, combiner_table_vjp_computation, combiner_weights_vjp_computation, table_name: str, clip_weight_min:float=float('-inf'), clip_weight_max:float=float('inf'), num_sparsecores_per_device:int=-1, name=None):
  r"""TODO: add doc.
  ...
  Returns:
    A tuple of `Tensor` objects (updated_embedding_table, updated_accumulator, updated_momenta, updated_weights).
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        ...
        preserved_vectors, preserved_weights, activation_gradients,
        learning_rate, combiner_weights_learning_rate, embedding_table,
        accumulator, momenta, "use_nesterov", use_nesterov, "exponent",
        exponent, "beta1", beta1, "beta2", beta2, "epsilon", epsilon,
        ...
        combiner_weights_vjp_computation, "table_name", table_name,
        "num_sparsecores_per_device", num_sparsecores_per_device)
      _result = _XlaSparseDenseMatmulCustomCombinerOnTcGradWithAdagradMomentumAndCsrInputOutput._make(_result)
      return _result
    except _core._NotOkStatusException as e:
      _ops.raise_from_not_ok_status(e, name)
    except _core._FallbackException:
      pass
    try:
      return xla_sparse_dense_matmul_custom_combiner_on_tc_grad_with_adagrad_momentum_and_csr_input_eager_fallback(
          row_pointers, sorted_sample_ids, sorted_token_ids, sorted_pos_ids,
          sorted_gains, weights, preserved_valencies, preserved_vectors,
          preserved_weights, activation_gradients, learning_rate,
          combiner_weights_learning_rate, embedding_table, accumulator,
          momenta, use_nesterov=use_nesterov, exponent=exponent, beta1=beta1,
          beta2=beta2, epsilon=epsilon, clip_weight_min=clip_weight_min,
          clip_weight_max=clip_weight_max, max_valency=max_valency,
          num_weights=num_weights,
          combiner_table_vjp_computation=combiner_table_vjp_computation,
          combiner_weights_vjp_computation=combiner_weights_vjp_computation,
          table_name=table_name,
  ...
  num_sparsecores_per_device = _execute.make_int(num_sparsecores_per_device, "num_sparsecores_per_device")
  _, _, _op, _outputs = _op_def_library._apply_op_helper(
        "XlaSparseDenseMatmulCustomCombinerOnTcGradWithAdagradMomentumAndCsrInput", row_pointers=row_pointers, sorted_sample_ids=sorted_sample_ids, sorted_token_ids=sorted_token_ids, sorted_pos_ids=sorted_pos_ids, sorted_gains=sorted_gains, weights=weights, preserved_valencies=preserved_valencies, preserved_vectors=preserved_vectors, preserved_weights=preserved_weights, activation_gradients=activation_gradients, learning_rate=learning_rate, combiner_weights_learning_rate=combiner_weights_learning_rate, embedding_table=embedding_table, accumulator=accumulator, momenta=momenta, use_nesterov=use_nesterov, exponent=exponent, beta1=beta1, beta2=beta2, epsilon=epsilon, max_valency=max_valency, num_weights=num_weights, combiner_table_vjp_computation=combiner_table_vjp_computation, combiner_weights_vjp_computation=combiner_weights_vjp_computation, table_name=table_name, clip_weight_min=clip_weight_min, clip_weight_max=clip_weight_max, num_sparsecores_per_device=num_sparsecores_per_device,
                                                                                    name=name)
  _result = _outputs[:]
  if _execute.must_record_gradient():
    _attrs = ("use_nesterov", _op._get_attr_bool("use_nesterov"), "exponent",
              ...
              _op.get_attr("clip_weight_max"), "max_valency",
              _op._get_attr_int("max_valency"), "num_weights",
              _op._get_attr_int("num_weights"),
              "combiner_table_vjp_computation",
              _op.get_attr("combiner_table_vjp_computation"),
              "combiner_weights_vjp_computation",
    ...
    _inputs_flat = _op.inputs
    _execute.record_gradient(
        "XlaSparseDenseMatmulCustomCombinerOnTcGradWithAdagradMomentumAndCsrInput", _inputs_flat, _attrs, _result)
  _result = _XlaSparseDenseMatmulCustomCombinerOnTcGradWithAdagradMomentumAndCsrInputOutput._make(_result)
  return _result

XlaSparseDenseMatmulCustomCombinerOnTcGradWithAdagradMomentumAndCsrInput = tf_export("raw_ops.XlaSparseDenseMatmulCustomCombinerOnTcGradWithAdagradMomentumAndCsrInput")(_ops.to_raw_op(xla_sparse_dense_matmul_custom_combiner_on_tc_grad_with_adagrad_momentum_and_csr_input))


def xla_sparse_dense_matmul_custom_combiner_on_tc_grad_with_adagrad_momentum_and_csr_input_eager_fallback(row_pointers: Annotated[Any, _atypes.Int32], sorted_sample_ids: Annotated[Any, _atypes.Int32], sorted_token_ids: Annotated[Any, _atypes.Int32], sorted_pos_ids: Annotated[Any, _atypes.Int32], sorted_gains: Annotated[Any, _atypes.Float32], weights: Annotated[Any, _atypes.Float32], preserved_valencies: Annotated[Any, _atypes.Int32], preserved_vectors: Annotated[Any, _atypes.Float32], preserved_weights: Annotated[Any, _atypes.Float32], activation_gradients: Annotated[Any, _atypes.Float32], learning_rate: Annotated[Any, _atypes.Float32], combiner_weights_learning_rate: Annotated[Any, _atypes.Float32], embedding_table: Annotated[Any, _atypes.Float32], accumulator: Annotated[Any, _atypes.Float32], momenta: Annotated[Any, _atypes.Float32], use_nesterov: bool, exponent: float, beta1: float, beta2: float, epsilon: float, max_valency: int, num_weights: int, combiner_table_vjp_computation, combiner_weights_vjp_computation, table_name: str, clip_weight_min: float, clip_weight_max: float, num_sparsecores_per_device: int, name, ctx):
  use_nesterov = _execute.make_bool(use_nesterov, "use_nesterov")
  exponent = _execute.make_float(exponent, "exponent")
  beta1 = _execute.make_float(beta1, "beta1")
  beta2 = _execute.make_float(beta2, "beta2")
  ...
  _inputs_flat = [row_pointers, sorted_sample_ids, sorted_token_ids, sorted_pos_ids, sorted_gains, weights, preserved_valencies, preserved_vectors, preserved_weights, activation_gradients, learning_rate, combiner_weights_learning_rate, embedding_table, accumulator, momenta]
  _attrs = ("use_nesterov", use_nesterov, "exponent", exponent, "beta1",
  beta1, "beta2", beta2, "epsilon", epsilon, "clip_weight_min",
  clip_weight_min, "clip_weight_max", clip_weight_max, "max_valency",
  max_valency, "num_weights", num_weights, "combiner_table_vjp_computation",
  combiner_table_vjp_computation, "combiner_weights_vjp_computation",
  combiner_weights_vjp_computation, "table_name", table_name,
  "num_sparsecores_per_device", num_sparsecores_per_device)
  _result = _execute.execute(b"XlaSparseDenseMatmulCustomCombinerOnTcGradWithAdagradMomentumAndCsrInput",
...
_XlaSparseDenseMatmulCustomCombinerOnTcGradWithAdamAndCsrInputOutput = collections.namedtuple(
    "XlaSparseDenseMatmulCustomCombinerOnTcGradWithAdamAndCsrInput",
    ["updated_embedding_table", "updated_momenta", "updated_velocity", "updated_weights"])


def xla_sparse_dense_matmul_custom_combiner_on_tc_grad_with_adam_and_csr_input(row_pointers: Annotated[Any, _atypes.Int32], sorted_sample_ids: Annotated[Any, _atypes.Int32], sorted_token_ids: Annotated[Any, _atypes.Int32], sorted_pos_ids: Annotated[Any, _atypes.Int32], sorted_gains: Annotated[Any, _atypes.Float32], weights: Annotated[Any, _atypes.Float32], preserved_valencies: Annotated[Any, _atypes.Int32], preserved_vectors: Annotated[Any, _atypes.Float32], preserved_weights: Annotated[Any, _atypes.Float32], activation_gradients: Annotated[Any, _atypes.Float32], learning_rate: Annotated[Any, _atypes.Float32], combiner_weights_learning_rate: Annotated[Any, _atypes.Float32], embedding_table: Annotated[Any, _atypes.Float32], momenta: Annotated[Any, _atypes.Float32], velocity: Annotated[Any, _atypes.Float32], use_sum_inside_sqrt: bool, beta1: float, beta2: float, epsilon: float, max_valency: int, num_weights: int, combiner_table_vjp_computation, combiner_weights_vjp_computation, table_name: str, clip_weight_min:float=float('-inf'), clip_weight_max:float=float('inf'), num_sparsecores_per_device:int=-1, name=None):
  r"""TODO: add doc.
  ...
  Returns:
    A tuple of `Tensor` objects (updated_embedding_table, updated_momenta, updated_velocity, updated_weights).
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx, "XlaSparseDenseMatmulCustomCombinerOnTcGradWithAdamAndCsrInput",
        name, row_pointers, sorted_sample_ids, sorted_token_ids,
        sorted_pos_ids, sorted_gains, weights, preserved_valencies,
        preserved_vectors, preserved_weights, activation_gradients,
        learning_rate, combiner_weights_learning_rate, embedding_table,
        momenta, velocity, "use_sum_inside_sqrt", use_sum_inside_sqrt,
        "beta1", beta1, "beta2", beta2, "epsilon", epsilon, "clip_weight_min",
        clip_weight_min, "clip_weight_max", clip_weight_max, "max_valency",
        max_valency, "num_weights", num_weights,
        "combiner_table_vjp_computation", combiner_table_vjp_computation,
        "combiner_weights_vjp_computation", combiner_weights_vjp_computation,
        "table_name", table_name, "num_sparsecores_per_device",
        num_sparsecores_per_device)
      _result = _XlaSparseDenseMatmulCustomCombinerOnTcGradWithAdamAndCsrInputOutput._make(_result)
      return _result
    except _core._NotOkStatusException as e:
      _ops.raise_from_not_ok_status(e, name)
    except _core._FallbackException:
      pass
    try:
      return xla_sparse_dense_matmul_custom_combiner_on_tc_grad_with_adam_and_csr_input_eager_fallback(
          row_pointers, sorted_sample_ids, sorted_token_ids, sorted_pos_ids,
          sorted_gains, weights, preserved_valencies, preserved_vectors,
          preserved_weights, activation_gradients, learning_rate,
          combiner_weights_learning_rate, embedding_table, momenta, velocity,
  ...
  num_sparsecores_per_device = _execute.make_int(num_sparsecores_per_device, "num_sparsecores_per_device")
  _, _, _op, _outputs = _op_def_library._apply_op_helper(
        "XlaSparseDenseMatmulCustomCombinerOnTcGradWithAdamAndCsrInput", row_pointers=row_pointers,
                                                                         sorted_sample_ids=sorted_sample_ids,
                                                                         sorted_token_ids=sorted_token_ids,
                                                                         sorted_pos_ids=sorted_pos_ids,
                                                                         sorted_gains=sorted_gains,
  ...
  if _execute.must_record_gradient():
    ...
    _inputs_flat = _op.inputs
    _execute.record_gradient(
        "XlaSparseDenseMatmulCustomCombinerOnTcGradWithAdamAndCsrInput", _inputs_flat, _attrs, _result)
  _result = _XlaSparseDenseMatmulCustomCombinerOnTcGradWithAdamAndCsrInputOutput._make(_result)
  return _result

XlaSparseDenseMatmulCustomCombinerOnTcGradWithAdamAndCsrInput = tf_export("raw_ops.XlaSparseDenseMatmulCustomCombinerOnTcGradWithAdamAndCsrInput")(_ops.to_raw_op(xla_sparse_dense_matmul_custom_combiner_on_tc_grad_with_adam_and_csr_input))


def xla_sparse_dense_matmul_custom_combiner_on_tc_grad_with_adam_and_csr_input_eager_fallback(row_pointers: Annotated[Any, _atypes.Int32], sorted_sample_ids: Annotated[Any, _atypes.Int32], sorted_token_ids: Annotated[Any, _atypes.Int32], sorted_pos_ids: Annotated[Any, _atypes.Int32], sorted_gains: Annotated[Any, _atypes.Float32], weights: Annotated[Any, _atypes.Float32], preserved_valencies: Annotated[Any, _atypes.Int32], preserved_vectors: Annotated[Any, _atypes.Float32], preserved_weights: Annotated[Any, _atypes.Float32], activation_gradients: Annotated[Any, _atypes.Float32], learning_rate: Annotated[Any, _atypes.Float32], combiner_weights_learning_rate: Annotated[Any, _atypes.Float32], embedding_table: Annotated[Any, _atypes.Float32], momenta: Annotated[Any, _atypes.Float32], velocity: Annotated[Any, _atypes.Float32], use_sum_inside_sqrt: bool, beta1: float, beta2: float, epsilon: float, max_valency: int, num_weights: int, combiner_table_vjp_computation, combiner_weights_vjp_computation, table_name: str, clip_weight_min: float, clip_weight_max: float, num_sparsecores_per_device: int, name, ctx):
  use_sum_inside_sqrt = _execute.make_bool(use_sum_inside_sqrt, "use_sum_inside_sqrt")
  beta1 = _execute.make_float(beta1, "beta1")
  beta2 = _execute.make_float(beta2, "beta2")
  epsilon = _execute.make_float(epsilon, "epsilon")
  ...
  momenta = _ops.convert_to_tensor(momenta, _dtypes.float32)
  velocity = _ops.convert_to_tensor(velocity, _dtypes.float32)
  _inputs_flat = [row_pointers, sorted_sample_ids, sorted_token_ids, sorted_pos_ids, sorted_gains, weights, preserved_valencies, preserved_vectors, preserved_weights, activation_gradients, learning_rate, combiner_weights_learning_rate, embedding_table, momenta, velocity]
  _attrs = ("use_sum_inside_sqrt", use_sum_inside_sqrt, "beta1", beta1,
  "beta2", beta2, "epsilon", epsilon, "clip_weight_min", clip_weight_min,
  "clip_weight_max", clip_weight_max, "max_valency", max_valency,
  "num_weights", num_weights, "combiner_table_vjp_computation",
  combiner_table_vjp_computation, "combiner_weights_vjp_computation",
  combiner_weights_vjp_computation, "table_name", table_name,
  "num_sparsecores_per_device", num_sparsecores_per_device)
  _result = _execute.execute(b"XlaSparseDenseMatmulCustomCombinerOnTcGradWithAdamAndCsrInput",
                             4, inputs=_inputs_flat, attrs=_attrs, ctx=ctx,
                             name=name)
  if _execute.must_record_gradient():
    _execute.record_gradient(
...
_XlaSparseDenseMatmulCustomCombinerOnTcGradWithCsrInputOutput = collections.namedtuple(
    "XlaSparseDenseMatmulCustomCombinerOnTcGradWithCsrInput",
    ["updated_tables", "updated_weights"])


def xla_sparse_dense_matmul_custom_combiner_on_tc_grad_with_csr_input(row_pointers: Annotated[Any, _atypes.Int32], sorted_sample_ids: Annotated[Any, _atypes.Int32], sorted_token_ids: Annotated[Any, _atypes.Int32], sorted_pos_ids: Annotated[Any, _atypes.Int32], sorted_gains: Annotated[Any, _atypes.Float32], weights: Annotated[Any, _atypes.Float32], preserved_valencies: Annotated[Any, _atypes.Int32], preserved_vectors: Annotated[Any, _atypes.Float32], preserved_weights: Annotated[Any, _atypes.Float32], activation_gradients: Annotated[Any, _atypes.Float32], tables: Annotated[List[Any], _atypes.Float32], hyperparameters: Annotated[List[Any], _atypes.Float32], combiner_weights_learning_rate: Annotated[Any, _atypes.Float32], max_valency: int, num_weights: int, combiner_table_vjp_computation, combiner_weights_vjp_computation, optimizer_custom_computation, table_name: str, num_sparsecores_per_device:int=-1, name=None):
  r"""TODO: add doc.
  ...
  Args:
    ...
    combiner_table_vjp_computation: A function decorated with @Defun.
    combiner_weights_vjp_computation: A function decorated with @Defun.
    optimizer_custom_computation: A function decorated with @Defun.
    table_name: A `string`.
    num_sparsecores_per_device: An optional `int`. Defaults to `-1`.
    name: A name for the operation (optional).

  Returns:
    A tuple of `Tensor` objects (updated_tables, updated_weights).

    updated_tables: A list with the same length as `tables` of `Tensor` objects with type `float32`.
    updated_weights: A `Tensor` of type `float32`.
  """
  _ctx = _context._context or _context.context()
  tld = _ctx._thread_local_data
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx, "XlaSparseDenseMatmulCustomCombinerOnTcGradWithCsrInput", name,
        row_pointers, sorted_sample_ids, sorted_token_ids, sorted_pos_ids,
        sorted_gains, weights, preserved_valencies, preserved_vectors,
        preserved_weights, activation_gradients, tables, hyperparameters,
        combiner_weights_learning_rate, "max_valency", max_valency,
        "num_weights", num_weights, "combiner_table_vjp_computation",
        combiner_table_vjp_computation, "combiner_weights_vjp_computation",
        combiner_weights_vjp_computation, "optimizer_custom_computation",
        optimizer_custom_computation, "table_name", table_name,
        "num_sparsecores_per_device", num_sparsecores_per_device)
      _result = _XlaSparseDenseMatmulCustomCombinerOnTcGradWithCsrInputOutput._make(_result)
      return _result
    except _core._NotOkStatusException as e:
      _ops.raise_from_not_ok_status(e, name)
    except _core._FallbackException:
      pass
    try:
      return xla_sparse_dense_matmul_custom_combiner_on_tc_grad_with_csr_input_eager_fallback(
          row_pointers, sorted_sample_ids, sorted_token_ids, sorted_pos_ids,
          sorted_gains, weights, preserved_valencies, preserved_vectors,
          preserved_weights, activation_gradients, tables, hyperparameters,
          combiner_weights_learning_rate, max_valency=max_valency,
          ...
          combiner_table_vjp_computation=combiner_table_vjp_computation,
          combiner_weights_vjp_computation=combiner_weights_vjp_computation,
          optimizer_custom_computation=optimizer_custom_computation,
          table_name=table_name,
          num_sparsecores_per_device=num_sparsecores_per_device, name=name,
          ctx=_ctx)
    except _core._SymbolicException:
  ...
  if not isinstance(tables, (list, tuple)):
    raise TypeError(
        ...
        "'xla_sparse_dense_matmul_custom_combiner_on_tc_grad_with_csr_input' Op, not %r." % tables)
  _attr_N = len(tables)
  if not isinstance(hyperparameters, (list, tuple)):
    raise TypeError(
        "Expected list for 'hyperparameters' argument to "
        "'xla_sparse_dense_matmul_custom_combiner_on_tc_grad_with_csr_input' Op, not %r." % hyperparameters)
  ...
  num_sparsecores_per_device = _execute.make_int(num_sparsecores_per_device, "num_sparsecores_per_device")
  _, _, _op, _outputs = _op_def_library._apply_op_helper(
        "XlaSparseDenseMatmulCustomCombinerOnTcGradWithCsrInput", row_pointers=row_pointers,
                                                                  sorted_sample_ids=sorted_sample_ids,
                                                                  sorted_token_ids=sorted_token_ids,
                                                                  sorted_pos_ids=sorted_pos_ids,
                                                                  sorted_gains=sorted_gains,
  ...
  if _execute.must_record_gradient():
    _attrs = ("N", _op._get_attr_int("N"), "M", _op._get_attr_int("M"),
              ...
              _op.get_attr("combiner_table_vjp_computation"),
              "combiner_weights_vjp_computation",
              _op.get_attr("combiner_weights_vjp_computation"),
              "optimizer_custom_computation",
              _op.get_attr("optimizer_custom_computation"), "table_name",
              _op.get_attr("table_name"), "num_sparsecores_per_device",
              _op._get_attr_int("num_sparsecores_per_device"))
    _inputs_flat = _op.inputs
    _execute.record_gradient(
        "XlaSparseDenseMatmulCustomCombinerOnTcGradWithCsrInput", _inputs_flat, _attrs, _result)
  _result = [_result[:_attr_N]] + _result[_attr_N:]
  _result = _XlaSparseDenseMatmulCustomCombinerOnTcGradWithCsrInputOutput._make(_result)
  return _result

XlaSparseDenseMatmulCustomCombinerOnTcGradWithCsrInput = tf_export("raw_ops.XlaSparseDenseMatmulCustomCombinerOnTcGradWithCsrInput")(_ops.to_raw_op(xla_sparse_dense_matmul_custom_combiner_on_tc_grad_with_csr_input))


def xla_sparse_dense_matmul_custom_combiner_on_tc_grad_with_csr_input_eager_fallback(row_pointers: Annotated[Any, _atypes.Int32], sorted_sample_ids: Annotated[Any, _atypes.Int32], sorted_token_ids: Annotated[Any, _atypes.Int32], sorted_pos_ids: Annotated[Any, _atypes.Int32], sorted_gains: Annotated[Any, _atypes.Float32], weights: Annotated[Any, _atypes.Float32], preserved_valencies: Annotated[Any, _atypes.Int32], preserved_vectors: Annotated[Any, _atypes.Float32], preserved_weights: Annotated[Any, _atypes.Float32], activation_gradients: Annotated[Any, _atypes.Float32], tables: Annotated[List[Any], _atypes.Float32], hyperparameters: Annotated[List[Any], _atypes.Float32], combiner_weights_learning_rate: Annotated[Any, _atypes.Float32], max_valency: int, num_weights: int, combiner_table_vjp_computation, combiner_weights_vjp_computation, optimizer_custom_computation, table_name: str, num_sparsecores_per_device: int, name, ctx):
  if not isinstance(tables, (list, tuple)):
    raise TypeError(
        "Expected list for 'tables' argument to "
        "'xla_sparse_dense_matmul_custom_combiner_on_tc_grad_with_csr_input' Op, not %r." % tables)
  ...
  combiner_weights_learning_rate = _ops.convert_to_tensor(combiner_weights_learning_rate, _dtypes.float32)
  _inputs_flat = [row_pointers, sorted_sample_ids, sorted_token_ids, sorted_pos_ids, sorted_gains, weights, preserved_valencies, preserved_vectors, preserved_weights, activation_gradients] + list(tables) + list(hyperparameters) + [combiner_weights_learning_rate]
  _attrs = ("N", _attr_N, "M", _attr_M, "max_valency", max_valency,
  "num_weights", num_weights, "combiner_table_vjp_computation",
  combiner_table_vjp_computation, "combiner_weights_vjp_computation",
  combiner_weights_vjp_computation, "optimizer_custom_computation",
  optimizer_custom_computation, "table_name", table_name,
  "num_sparsecores_per_device", num_sparsecores_per_device)
  _result = _execute.execute(b"XlaSparseDenseMatmulCustomCombinerOnTcGradWithCsrInput",
                             _attr_N + 1, inputs=_inputs_flat, attrs=_attrs,
                             ctx=ctx, name=name)
  if _execute.must_record_gradient():
    _execute.record_gradient(
        "XlaSparseDenseMatmulCustomCombinerOnTcGradWithCsrInput", _inputs_flat, _attrs, _result)
...
_XlaSparseDenseMatmulCustomCombinerOnTcGradWithFtrlAndCsrInputOutput = collections.namedtuple(
    "XlaSparseDenseMatmulCustomCombinerOnTcGradWithFtrlAndCsrInput",
    ["updated_embedding_table", "updated_accumulator", "updated_linear", "updated_weights"])


def xla_sparse_dense_matmul_custom_combiner_on_tc_grad_with_ftrl_and_csr_input(row_pointers: Annotated[Any, _atypes.Int32], sorted_sample_ids: Annotated[Any, _atypes.Int32], sorted_token_ids: Annotated[Any, _atypes.Int32], sorted_pos_ids: Annotated[Any, _atypes.Int32], sorted_gains: Annotated[Any, _atypes.Float32], weights: Annotated[Any, _atypes.Float32], preserved_valencies: Annotated[Any, _atypes.Int32], preserved_vectors: Annotated[Any, _atypes.Float32], preserved_weights: Annotated[Any, _atypes.Float32], activation_gradients: Annotated[Any, _atypes.Float32], learning_rate: Annotated[Any, _atypes.Float32], combiner_weights_learning_rate: Annotated[Any, _atypes.Float32], embedding_table: Annotated[Any, _atypes.Float32], accumulator: Annotated[Any, _atypes.Float32], linear: Annotated[Any, _atypes.Float32], multiply_linear_by_learning_rate: bool, beta: float, learning_rate_power: float, l1_regularization_strength: float, l2_regularization_strength: float, max_valency: int, num_weights: int, combiner_table_vjp_computation, combiner_weights_vjp_computation, table_name: str, clip_weight_min:float=float('-inf'), clip_weight_max:float=float('inf'), num_sparsecores_per_device:int=-1, name=None):
  r"""TODO: add doc.
  ...
  Returns:
    A tuple of `Tensor` objects (updated_embedding_table, updated_accumulator, updated_linear, updated_weights).
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx, "XlaSparseDenseMatmulCustomCombinerOnTcGradWithFtrlAndCsrInput",
        name, row_pointers, sorted_sample_ids, sorted_token_ids,
        sorted_pos_ids, sorted_gains, weights, preserved_valencies,
        preserved_vectors, preserved_weights, activation_gradients,
        learning_rate, combiner_weights_learning_rate, embedding_table,
        accumulator, linear, "multiply_linear_by_learning_rate",
        ...
        combiner_weights_vjp_computation, "table_name", table_name,
        "num_sparsecores_per_device", num_sparsecores_per_device)
      _result = _XlaSparseDenseMatmulCustomCombinerOnTcGradWithFtrlAndCsrInputOutput._make(_result)
      return _result
    except _core._NotOkStatusException as e:
      _ops.raise_from_not_ok_status(e, name)
    except _core._FallbackException:
      pass
    try:
      return xla_sparse_dense_matmul_custom_combiner_on_tc_grad_with_ftrl_and_csr_input_eager_fallback(
          row_pointers, sorted_sample_ids, sorted_token_ids, sorted_pos_ids,
          sorted_gains, weights, preserved_valencies, preserved_vectors,
          preserved_weights, activation_gradients, learning_rate,
          combiner_weights_learning_rate, embedding_table, accumulator,
  ...
  num_sparsecores_per_device = _execute.make_int(num_sparsecores_per_device, "num_sparsecores_per_device")
  _, _, _op, _outputs = _op_def_library._apply_op_helper(
        "XlaSparseDenseMatmulCustomCombinerOnTcGradWithFtrlAndCsrInput", row_pointers=row_pointers,
                                                                         sorted_sample_ids=sorted_sample_ids,
                                                                         sorted_token_ids=sorted_token_ids,
                                                                         sorted_pos_ids=sorted_pos_ids,
                                                                         sorted_gains=sorted_gains,
  ...
  if _execute.must_record_gradient():
    ...
    _inputs_flat = _op.inputs
    _execute.record_gradient(
        "XlaSparseDenseMatmulCustomCombinerOnTcGradWithFtrlAndCsrInput", _inputs_flat, _attrs, _result)
  _result = _XlaSparseDenseMatmulCustomCombinerOnTcGradWithFtrlAndCsrInputOutput._make(_result)
  return _result

XlaSparseDenseMatmulCustomCombinerOnTcGradWithFtrlAndCsrInput = tf_export("raw_ops.XlaSparseDenseMatmulCustomCombinerOnTcGradWithFtrlAndCsrInput")(_ops.to_raw_op(xla_sparse_dense_matmul_custom_combiner_on_tc_grad_with_ftrl_and_csr_input))


def xla_sparse_dense_matmul_custom_combiner_on_tc_grad_with_ftrl_and_csr_input_eager_fallback(row_pointers: Annotated[Any, _atypes.Int32], sorted_sample_ids: Annotated[Any, _atypes.Int32], sorted_token_ids: Annotated[Any, _atypes.Int32], sorted_pos_ids: Annotated[Any, _atypes.Int32], sorted_gains: Annotated[Any, _atypes.Float32], weights: Annotated[Any, _atypes.Float32], preserved_valencies: Annotated[Any, _atypes.Int32], preserved_vectors: Annotated[Any, _atypes.Float32], preserved_weights: Annotated[Any, _atypes.Float32], activation_gradients: Annotated[Any, _atypes.Float32], learning_rate: Annotated[Any, _atypes.Float32], combiner_weights_learning_rate: Annotated[Any, _atypes.Float32], embedding_table: Annotated[Any, _atypes.Float32], accumulator: Annotated[Any, _atypes.Float32], linear: Annotated[Any, _atypes.Float32], multiply_linear_by_learning_rate: bool, beta: float, learning_rate_power: float, l1_regularization_strength: float, l2_regularization_strength: float, max_valency: int, num_weights: int, combiner_table_vjp_computation, combiner_weights_vjp_computation, table_name: str, clip_weight_min: float, clip_weight_max: float, num_sparsecores_per_device: int, name, ctx):
  multiply_linear_by_learning_rate = _execute.make_bool(multiply_linear_by_learning_rate, "multiply_linear_by_learning_rate")
  beta = _execute.make_float(beta, "beta")
  learning_rate_power = _execute.make_float(learning_rate_power, "learning_rate_power")
  l1_regularization_strength = _execute.make_float(l1_regularization_strength, "l1_regularization_strength")
  ...
  accumulator = _ops.convert_to_tensor(accumulator, _dtypes.float32)
  linear = _ops.convert_to_tensor(linear, _dtypes.float32)
  _inputs_flat = [row_pointers, sorted_sample_ids, sorted_token_ids, sorted_pos_ids, sorted_gains, weights, preserved_valencies, preserved_vectors, preserved_weights, activation_gradients, learning_rate, combiner_weights_learning_rate, embedding_table, accumulator, linear]
  _attrs = ("multiply_linear_by_learning_rate",
  multiply_linear_by_learning_rate, "beta", beta, "learning_rate_power",
  learning_rate_power, "l1_regularization_strength",
  l1_regularization_strength, "l2_regularization_strength",
  ...
  combiner_weights_vjp_computation, "table_name", table_name,
  "num_sparsecores_per_device", num_sparsecores_per_device)
  _result = _execute.execute(b"XlaSparseDenseMatmulCustomCombinerOnTcGradWithFtrlAndCsrInput",
                             4, inputs=_inputs_flat, attrs=_attrs, ctx=ctx,
                             name=name)
  if _execute.must_record_gradient():
    _execute.record_gradient(
...
_XlaSparseDenseMatmulCustomCombinerOnTcGradWithSgdAndCsrInputOutput = collections.namedtuple(
    "XlaSparseDenseMatmulCustomCombinerOnTcGradWithSgdAndCsrInput",
    ["updated_embedding_table", "updated_weights"])


def xla_sparse_dense_matmul_custom_combiner_on_tc_grad_with_sgd_and_csr_input(row_pointers: Annotated[Any, _atypes.Int32], sorted_sample_ids: Annotated[Any, _atypes.Int32], sorted_token_ids: Annotated[Any, _atypes.Int32], sorted_pos_ids: Annotated[Any, _atypes.Int32], sorted_gains: Annotated[Any, _atypes.Float32], weights: Annotated[Any, _atypes.Float32], preserved_valencies: Annotated[Any, _atypes.Int32], preserved_vectors: Annotated[Any, _atypes.Float32], preserved_weights: Annotated[Any, _atypes.Float32], activation_gradients: Annotated[Any, _atypes.Float32], learning_rate: Annotated[Any, _atypes.Float32], combiner_weights_learning_rate: Annotated[Any, _atypes.Float32], embedding_table: Annotated[Any, _atypes.Float32], max_valency: int, num_weights: int, combiner_table_vjp_computation, combiner_weights_vjp_computation, table_name: str, clip_weight_min:float=float('-inf'), clip_weight_max:float=float('inf'), num_sparsecores_per_device:int=-1, name=None):
  r"""TODO: add doc.
  ...
  Returns:
    A tuple of `Tensor` objects (updated_embedding_table, updated_weights).
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx, "XlaSparseDenseMatmulCustomCombinerOnTcGradWithSgdAndCsrInput",
        name, row_pointers, sorted_sample_ids, sorted_token_ids,
        sorted_pos_ids, sorted_gains, weights, preserved_valencies,
        preserved_vectors, preserved_weights, activation_gradients,
        learning_rate, combiner_weights_learning_rate, embedding_table,
        ...
        combiner_weights_vjp_computation, "table_name", table_name,
        "num_sparsecores_per_device", num_sparsecores_per_device)
      _result = _XlaSparseDenseMatmulCustomCombinerOnTcGradWithSgdAndCsrInputOutput._make(_result)
      return _result
    except _core._NotOkStatusException as e:
      _ops.raise_from_not_ok_status(e, name)
    except _core._FallbackException:
      pass
    try:
      return xla_sparse_dense_matmul_custom_combiner_on_tc_grad_with_sgd_and_csr_input_eager_fallback(
          row_pointers, sorted_sample_ids, sorted_token_ids, sorted_pos_ids,
          sorted_gains, weights, preserved_valencies, preserved_vectors,
          preserved_weights, activation_gradients, learning_rate,
          combiner_weights_learning_rate, embedding_table,
          clip_weight_min=clip_weight_min, clip_weight_max=clip_weight_max,
          max_valency=max_valency, num_weights=num_weights,
          combiner_table_vjp_computation=combiner_table_vjp_computation,
          combiner_weights_vjp_computation=combiner_weights_vjp_computation,
  ...
  num_sparsecores_per_device = _execute.make_int(num_sparsecores_per_device, "num_sparsecores_per_device")
  _, _, _op, _outputs = _op_def_library._apply_op_helper(
        "XlaSparseDenseMatmulCustomCombinerOnTcGradWithSgdAndCsrInput", row_pointers=row_pointers,
                                                                        sorted_sample_ids=sorted_sample_ids,
                                                                        sorted_token_ids=sorted_token_ids,
                                                                        sorted_pos_ids=sorted_pos_ids,
                                                                        sorted_gains=sorted_gains,
  ...
  if _execute.must_record_gradient():
    ...
    _inputs_flat = _op.inputs
    _execute.record_gradient(
        "XlaSparseDenseMatmulCustomCombinerOnTcGradWithSgdAndCsrInput", _inputs_flat, _attrs, _result)
  _result = _XlaSparseDenseMatmulCustomCombinerOnTcGradWithSgdAndCsrInputOutput._make(_result)
  return _result

XlaSparseDenseMatmulCustomCombinerOnTcGradWithSgdAndCsrInput = tf_export("raw_ops.XlaSparseDenseMatmulCustomCombinerOnTcGradWithSgdAndCsrInput")(_ops.to_raw_op(xla_sparse_dense_matmul_custom_combiner_on_tc_grad_with_sgd_and_csr_input))


def xla_sparse_dense_matmul_custom_combiner_on_tc_grad_with_sgd_and_csr_input_eager_fallback(row_pointers: Annotated[Any, _atypes.Int32], sorted_sample_ids: Annotated[Any, _atypes.Int32], sorted_token_ids: Annotated[Any, _atypes.Int32], sorted_pos_ids: Annotated[Any, _atypes.Int32], sorted_gains: Annotated[Any, _atypes.Float32], weights: Annotated[Any, _atypes.Float32], preserved_valencies: Annotated[Any, _atypes.Int32], preserved_vectors: Annotated[Any, _atypes.Float32], preserved_weights: Annotated[Any, _atypes.Float32], activation_gradients: Annotated[Any, _atypes.Float32], learning_rate: Annotated[Any, _atypes.Float32], combiner_weights_learning_rate: Annotated[Any, _atypes.Float32], embedding_table: Annotated[Any, _atypes.Float32], max_valency: int, num_weights: int, combiner_table_vjp_computation, combiner_weights_vjp_computation, table_name: str, clip_weight_min: float, clip_weight_max: float, num_sparsecores_per_device: int, name, ctx):
  max_valency = _execute.make_int(max_valency, "max_valency")
  num_weights = _execute.make_int(num_weights, "num_weights")
  table_name = _execute.make_str(table_name, "table_name")
  if clip_weight_min is None:
  ...
  combiner_weights_learning_rate = _ops.convert_to_tensor(combiner_weights_learning_rate, _dtypes.float32)
  embedding_table = _ops.convert_to_tensor(embedding_table, _dtypes.float32)
  _inputs_flat = [row_pointers, sorted_sample_ids, sorted_token_ids, sorted_pos_ids, sorted_gains, weights, preserved_valencies, preserved_vectors, preserved_weights, activation_gradients, learning_rate, combiner_weights_learning_rate, embedding_table]
  _attrs = ("clip_weight_min", clip_weight_min, "clip_weight_max",
  clip_weight_max, "max_valency", max_valency, "num_weights", num_weights,
  "combiner_table_vjp_computation", combiner_table_vjp_computation,
  "combiner_weights_vjp_computation", combiner_weights_vjp_computation,
  "table_name", table_name, "num_sparsecores_per_device",
  num_sparsecores_per_device)
  _result = _execute.execute(b"XlaSparseDenseMatmulCustomCombinerOnTcGradWithSgdAndCsrInput",
...
_XlaSparseDenseMatmulCustomCombinerOnTcWithCsrInputOutput = collections.namedtuple(
    "XlaSparseDenseMatmulCustomCombinerOnTcWithCsrInput",
    ["activations", "preserved_valencies", "preserved_vectors"])


def xla_sparse_dense_matmul_custom_combiner_on_tc_with_csr_input(row_pointers: Annotated[Any, _atypes.Int32], sorted_sample_ids: Annotated[Any, _atypes.Int32], sorted_token_ids: Annotated[Any, _atypes.Int32], sorted_pos_ids: Annotated[Any, _atypes.Int32], sorted_gains: Annotated[Any, _atypes.Float32], embedding_table: Annotated[Any, _atypes.Float32], weights: Annotated[Any, _atypes.Float32], input_size: int, max_valency: int, num_weights: int, combiner_computation, quantization_config_low: float, quantization_config_high: float, quantization_config_num_buckets: int, table_name: str, num_sparsecores_per_device:int=-1, name=None):
  r"""TODO: add doc.
  ...
  Args:
    ...
    max_valency: An `int` that is `>= 0`.
    num_weights: An `int` that is `>= 0`.
    combiner_computation: A function decorated with @Defun.
  ...
  Returns:
    A tuple of `Tensor` objects (activations, preserved_valencies, preserved_vectors).
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx, "XlaSparseDenseMatmulCustomCombinerOnTcWithCsrInput", name,
        row_pointers, sorted_sample_ids, sorted_token_ids, sorted_pos_ids,
        sorted_gains, embedding_table, weights, "input_size", input_size,
        "max_valency", max_valency, "num_weights", num_weights,
        "combiner_computation", combiner_computation,
        ...
        "table_name", table_name, "num_sparsecores_per_device",
        num_sparsecores_per_device)
      _result = _XlaSparseDenseMatmulCustomCombinerOnTcWithCsrInputOutput._make(_result)
      return _result
    except _core._NotOkStatusException as e:
      _ops.raise_from_not_ok_status(e, name)
    except _core._FallbackException:
      pass
    try:
      return xla_sparse_dense_matmul_custom_combiner_on_tc_with_csr_input_eager_fallback(
          row_pointers, sorted_sample_ids, sorted_token_ids, sorted_pos_ids,
          sorted_gains, embedding_table, weights, input_size=input_size,
          max_valency=max_valency, num_weights=num_weights,
          combiner_computation=combiner_computation,
  ...
  num_sparsecores_per_device = _execute.make_int(num_sparsecores_per_device, "num_sparsecores_per_device")
  _, _, _op, _outputs = _op_def_library._apply_op_helper(
        "XlaSparseDenseMatmulCustomCombinerOnTcWithCsrInput", row_pointers=row_pointers,
                                                              sorted_sample_ids=sorted_sample_ids,
                                                              sorted_token_ids=sorted_token_ids,
                                                              sorted_pos_ids=sorted_pos_ids,
                                                              sorted_gains=sorted_gains,
  ...
  _result = _outputs[:]
  if _execute.must_record_gradient():
    _attrs = ("input_size", _op._get_attr_int("input_size"), "max_valency",
              _op._get_attr_int("max_valency"), "num_weights",
              _op._get_attr_int("num_weights"), "combiner_computation",
              _op.get_attr("combiner_computation"), "quantization_config_low",
    ...
    _inputs_flat = _op.inputs
    _execute.record_gradient(
        "XlaSparseDenseMatmulCustomCombinerOnTcWithCsrInput", _inputs_flat, _attrs, _result)
  _result = _XlaSparseDenseMatmulCustomCombinerOnTcWithCsrInputOutput._make(_result)
  return _result

XlaSparseDenseMatmulCustomCombinerOnTcWithCsrInput = tf_export("raw_ops.XlaSparseDenseMatmulCustomCombinerOnTcWithCsrInput")(_ops.to_raw_op(xla_sparse_dense_matmul_custom_combiner_on_tc_with_csr_input))


def xla_sparse_dense_matmul_custom_combiner_on_tc_with_csr_input_eager_fallback(row_pointers: Annotated[Any, _atypes.Int32], sorted_sample_ids: Annotated[Any, _atypes.Int32], sorted_token_ids: Annotated[Any, _atypes.Int32], sorted_pos_ids: Annotated[Any, _atypes.Int32], sorted_gains: Annotated[Any, _atypes.Float32], embedding_table: Annotated[Any, _atypes.Float32], weights: Annotated[Any, _atypes.Float32], input_size: int, max_valency: int, num_weights: int, combiner_computation, quantization_config_low: float, quantization_config_high: float, quantization_config_num_buckets: int, table_name: str, num_sparsecores_per_device: int, name, ctx):
  input_size = _execute.make_int(input_size, "input_size")
  max_valency = _execute.make_int(max_valency, "max_valency")
  num_weights = _execute.make_int(num_weights, "num_weights")
  quantization_config_low = _execute.make_float(quantization_config_low, "quantization_config_low")
  ...
  embedding_table = _ops.convert_to_tensor(embedding_table, _dtypes.float32)
  weights = _ops.convert_to_tensor(weights, _dtypes.float32)
  _inputs_flat = [row_pointers, sorted_sample_ids, sorted_token_ids, sorted_pos_ids, sorted_gains, embedding_table, weights]
  _attrs = ("input_size", input_size, "max_valency", max_valency,
  "num_weights", num_weights, "combiner_computation", combiner_computation,
  "quantization_config_low", quantization_config_low,
  "quantization_config_high", quantization_config_high,
  "quantization_config_num_buckets", quantization_config_num_buckets,
  "table_name", table_name, "num_sparsecores_per_device",
  num_sparsecores_per_device)
  _result = _execute.execute(b"XlaSparseDenseMatmulCustomCombinerOnTcWithCsrInput",
                             3, inputs=_inputs_flat, attrs=_attrs, ctx=ctx,
                             name=name)
  if _execute.must_record_gradient():
    _execute.record_gradient(
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        ...
        table_name, "num_sparsecores_per_device", num_sparsecores_per_device)
...
def xla_sparse_dense_matmul_grad_with_adagrad_and_csr_input_eager_fallback(row_pointers: Annotated[Any, _atypes.Int32], sorted_sample_ids: Annotated[Any, _atypes.Int32], sorted_token_ids: Annotated[Any, _atypes.Int32], sorted_gains: Annotated[Any, _atypes.Float32], activation_gradients: Annotated[Any, _atypes.Float32], learning_rate: Annotated[Any, _atypes.Float32], embedding_table: Annotated[Any, _atypes.Float32], accumulator: Annotated[Any, _atypes.Float32], num_minibatches_per_physical_sparse_core: Annotated[Any, _atypes.Int32], table_name: str, clip_weight_min: float, clip_weight_max: float, num_sparsecores_per_device: int, name, ctx):
  ...
  _attrs = ("clip_weight_min", clip_weight_min, "clip_weight_max",
  clip_weight_max, "table_name", table_name, "num_sparsecores_per_device",
  num_sparsecores_per_device)
...
TV_XlaSparseDenseMatmulGradWithCsrInput_T = TypeVar("TV_XlaSparseDenseMatmulGradWithCsrInput_T", "_atypes.Float32", "_atypes.Int32")

def xla_sparse_dense_matmul_grad_with_csr_input(row_pointers: Annotated[Any, _atypes.Int32], sorted_sample_ids: Annotated[Any, _atypes.Int32], sorted_token_ids: Annotated[Any, _atypes.Int32], sorted_gains: Annotated[Any, _atypes.Float32], activation_gradients: Annotated[Any, _atypes.Float32], tables: Annotated[List[Any], TV_XlaSparseDenseMatmulGradWithCsrInput_T], hyperparameters: Annotated[List[Any], _atypes.Float32], num_minibatches_per_physical_sparse_core: Annotated[Any, _atypes.Int32], custom_computation, table_name: str, num_sparsecores_per_device:int=-1, name=None):
  r"""TODO: add doc.
  ...
  Args:
    ...
    sorted_gains: A `Tensor` of type `float32`.
    activation_gradients: A `Tensor` of type `float32`.
    tables: A list of at least 1 `Tensor` objects with the same type in: `int32`, `float32`.
    hyperparameters: A list of at least 1 `Tensor` objects with type `float32`.
    num_minibatches_per_physical_sparse_core: A `Tensor` of type `int32`.
  ...
  Returns:
    A list with the same length as `tables` of `Tensor` objects with the same type as `tables`.
  """
  _ctx = _context._context or _context.context()
  tld = _ctx._thread_local_data
  if tld.is_eager:
  ...
  if _execute.must_record_gradient():
    _attrs = ("N", _op._get_attr_int("N"), "M", _op._get_attr_int("M"),
              ...
              "table_name", _op.get_attr("table_name"),
              "num_sparsecores_per_device",
              _op._get_attr_int("num_sparsecores_per_device"), "T",
...
def xla_sparse_dense_matmul_grad_with_csr_input_eager_fallback(row_pointers: Annotated[Any, _atypes.Int32], sorted_sample_ids: Annotated[Any, _atypes.Int32], sorted_token_ids: Annotated[Any, _atypes.Int32], sorted_gains: Annotated[Any, _atypes.Float32], activation_gradients: Annotated[Any, _atypes.Float32], tables: Annotated[List[Any], TV_XlaSparseDenseMatmulGradWithCsrInput_T], hyperparameters: Annotated[List[Any], _atypes.Float32], num_minibatches_per_physical_sparse_core: Annotated[Any, _atypes.Int32], custom_computation, table_name: str, num_sparsecores_per_device: int, name, ctx):
  if not isinstance(tables, (list, tuple)):
    raise TypeError(
        "Expected list for 'tables' argument to "
        "'xla_sparse_dense_matmul_grad_with_csr_input' Op, not %r." % tables)
  ...
  if num_sparsecores_per_device is None:
    num_sparsecores_per_device = -1
  num_sparsecores_per_device = _execute.make_int(num_sparsecores_per_device, "num_sparsecores_per_device")
  _attr_T, tables = _execute.args_to_matching_eager(list(tables), ctx, [_dtypes.int32, _dtypes.float32, ], _dtypes.float32)
  row_pointers = _ops.convert_to_tensor(row_pointers, _dtypes.int32)
  sorted_sample_ids = _ops.convert_to_tensor(sorted_sample_ids, _dtypes.int32)
  sorted_token_ids = _ops.convert_to_tensor(sorted_token_ids, _dtypes.int32)
  sorted_gains = _ops.convert_to_tensor(sorted_gains, _dtypes.float32)
  ...
  custom_computation, "table_name", table_name, "num_sparsecores_per_device",
  num_sparsecores_per_device, "T", _attr_T)
...
def xla_sparse_dense_matmul_grad_with_ftrl_and_csr_input_eager_fallback(row_pointers: Annotated[Any, _atypes.Int32], sorted_sample_ids: Annotated[Any, _atypes.Int32], sorted_token_ids: Annotated[Any, _atypes.Int32], sorted_gains: Annotated[Any, _atypes.Float32], activation_gradients: Annotated[Any, _atypes.Float32], learning_rate: Annotated[Any, _atypes.Float32], embedding_table: Annotated[Any, _atypes.Float32], accumulator: Annotated[Any, _atypes.Float32], linear: Annotated[Any, _atypes.Float32], num_minibatches_per_physical_sparse_core: Annotated[Any, _atypes.Int32], multiply_linear_by_learning_rate: bool, beta: float, learning_rate_power: float, l1_regularization_strength: float, l2_regularization_strength: float, table_name: str, clip_weight_min: float, clip_weight_max: float, num_sparsecores_per_device: int, name, ctx):
  multiply_linear_by_learning_rate = _execute.make_bool(multiply_linear_by_learning_rate, "multiply_linear_by_learning_rate")
  beta = _execute.make_float(beta, "beta")
  learning_rate_power = _execute.make_float(learning_rate_power, "learning_rate_power")
  l1_regularization_strength = _execute.make_float(l1_regularization_strength, "l1_regularization_strength")
...
TV_XlaSparseDenseMatmulWithCsrInput_T = TypeVar("TV_XlaSparseDenseMatmulWithCsrInput_T", "_atypes.Float32", "_atypes.Int32")

def xla_sparse_dense_matmul_with_csr_input(row_pointers: Annotated[Any, _atypes.Int32], sorted_sample_ids: Annotated[Any, _atypes.Int32], sorted_token_ids: Annotated[Any, _atypes.Int32], sorted_gains: Annotated[Any, _atypes.Float32], embedding_table: Annotated[Any, TV_XlaSparseDenseMatmulWithCsrInput_T], num_minibatches_per_physical_sparse_core: Annotated[Any, _atypes.Int32], input_size: int, quantization_config_low: float, quantization_config_high: float, quantization_config_num_buckets: int, table_name: str, num_sparsecores_per_device:int=-1, name=None) -> Annotated[Any, TV_XlaSparseDenseMatmulWithCsrInput_T]:
  r"""TODO: add doc.
  ...
  Args:
    ...
    sorted_token_ids: A `Tensor` of type `int32`.
    sorted_gains: A `Tensor` of type `float32`.
    embedding_table: A `Tensor`. Must be one of the following types: `int32`, `float32`.
    num_minibatches_per_physical_sparse_core: A `Tensor` of type `int32`.
    input_size: An `int` that is `>= 0`.
    quantization_config_low: A `float`.
    quantization_config_high: A `float`.
  ...
  Returns:
    A `Tensor`. Has the same type as `embedding_table`.
  """
  _ctx = _context._context or _context.context()
  tld = _ctx._thread_local_data
  if tld.is_eager:
...
def xla_sparse_dense_matmul_with_csr_input_eager_fallback(row_pointers: Annotated[Any, _atypes.Int32], sorted_sample_ids: Annotated[Any, _atypes.Int32], sorted_token_ids: Annotated[Any, _atypes.Int32], sorted_gains: Annotated[Any, _atypes.Float32], embedding_table: Annotated[Any, TV_XlaSparseDenseMatmulWithCsrInput_T], num_minibatches_per_physical_sparse_core: Annotated[Any, _atypes.Int32], input_size: int, quantization_config_low: float, quantization_config_high: float, quantization_config_num_buckets: int, table_name: str, num_sparsecores_per_device: int, name, ctx) -> Annotated[Any, TV_XlaSparseDenseMatmulWithCsrInput_T]:
  input_size = _execute.make_int(input_size, "input_size")
  quantization_config_low = _execute.make_float(quantization_config_low, "quantization_config_low")
  quantization_config_high = _execute.make_float(quantization_config_high, "quantization_config_high")
  quantization_config_num_buckets = _execute.make_int(quantization_config_num_buckets, "quantization_config_num_buckets")
  ...
  if num_sparsecores_per_device is None:
    num_sparsecores_per_device = -1
  num_sparsecores_per_device = _execute.make_int(num_sparsecores_per_device, "num_sparsecores_per_device")
  _attr_T, (embedding_table,) = _execute.args_to_matching_eager([embedding_table], ctx, [_dtypes.int32, _dtypes.float32, ], _dtypes.float32)
  row_pointers = _ops.convert_to_tensor(row_pointers, _dtypes.int32)
  sorted_sample_ids = _ops.convert_to_tensor(sorted_sample_ids, _dtypes.int32)
  sorted_token_ids = _ops.convert_to_tensor(sorted_token_ids, _dtypes.int32)
  sorted_gains = _ops.convert_to_tensor(sorted_gains, _dtypes.float32)
  ...
  "num_sparsecores_per_device", num_sparsecores_per_device, "T", _attr_T)
