...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'tensorflow.core.framework.tensor_description_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_TENSORDESCRIPTION']._serialized_start=208
