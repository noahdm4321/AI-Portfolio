...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'tensorflow.core.framework.cost_graph_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_COSTGRAPHDEF_NODE'].fields_by_name['host_temp_memory_size']._loaded_options = None
  _globals['_COSTGRAPHDEF_NODE'].fields_by_name['host_temp_memory_size']._serialized_options = b'\030\001'
  _globals['_COSTGRAPHDEF_NODE'].fields_by_name['device_temp_memory_size']._loaded_options = None
  _globals['_COSTGRAPHDEF_NODE'].fields_by_name['device_temp_memory_size']._serialized_options = b'\030\001'
  _globals['_COSTGRAPHDEF_NODE'].fields_by_name['device_persistent_memory_size']._loaded_options = None
  _globals['_COSTGRAPHDEF_NODE'].fields_by_name['device_persistent_memory_size']._serialized_options = b'\030\001'
  _globals['_COSTGRAPHDEF']._serialized_start=144
  _globals['_COSTGRAPHDEF']._serialized_end=986
  _globals['_COSTGRAPHDEF_NODE']._serialized_start=261
  _globals['_COSTGRAPHDEF_NODE']._serialized_end=935
  _globals['_COSTGRAPHDEF_NODE_INPUTINFO']._serialized_start=739
  _globals['_COSTGRAPHDEF_NODE_INPUTINFO']._serialized_end=798
  _globals['_COSTGRAPHDEF_NODE_OUTPUTINFO']._serialized_start=801
  _globals['_COSTGRAPHDEF_NODE_OUTPUTINFO']._serialized_end=935
  _globals['_COSTGRAPHDEF_AGGREGATEDCOST']._serialized_start=937
  _globals['_COSTGRAPHDEF_AGGREGATEDCOST']._serialized_end=986
