...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'tensorflow.core.framework.step_stats_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_MEMORYSTATS'].fields_by_name['device_temp_memory_size']._loaded_options = None
  _globals['_MEMORYSTATS'].fields_by_name['device_temp_memory_size']._serialized_options = b'\030\001'
  _globals['_MEMORYSTATS'].fields_by_name['device_persistent_memory_size']._loaded_options = None
  _globals['_MEMORYSTATS'].fields_by_name['device_persistent_memory_size']._serialized_options = b'\030\001'
  _globals['_MEMORYSTATS'].fields_by_name['device_persistent_tensor_alloc_ids']._loaded_options = None
  _globals['_MEMORYSTATS'].fields_by_name['device_persistent_tensor_alloc_ids']._serialized_options = b'\030\001'
  _globals['_DEVICESTEPSTATS_THREADNAMESENTRY']._loaded_options = None
  _globals['_DEVICESTEPSTATS_THREADNAMESENTRY']._serialized_options = b'8\001'
  _globals['_ALLOCATIONRECORD']._serialized_start=166
  _globals['_ALLOCATIONRECORD']._serialized_end=227
  _globals['_ALLOCATORMEMORYUSED']._serialized_start=230
  _globals['_ALLOCATORMEMORYUSED']._serialized_end=426
  _globals['_NODEOUTPUT']._serialized_start=428
  _globals['_NODEOUTPUT']._serialized_end=513
  _globals['_MEMORYSTATS']._serialized_start=516
  _globals['_MEMORYSTATS']._serialized_end=752
  _globals['_NODEEXECSTATS']._serialized_start=755
  _globals['_NODEEXECSTATS']._serialized_end=1297
  _globals['_DEVICESTEPSTATS']._serialized_start=1300
  _globals['_DEVICESTEPSTATS']._serialized_end=1500
  _globals['_DEVICESTEPSTATS_THREADNAMESENTRY']._serialized_start=1450
  _globals['_DEVICESTEPSTATS_THREADNAMESENTRY']._serialized_end=1500
  _globals['_STEPSTATS']._serialized_start=1502
  _globals['_STEPSTATS']._serialized_end=1561
