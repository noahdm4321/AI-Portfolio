...
extern nvJitLinkResult __nvJitLinkCreate_12_5(
...
static inline nvJitLinkResult nvJitLinkCreate(
  ...
  const char **options)
{
  return __nvJitLinkCreate_12_5 (handle, numOptions, options);
}
#endif
 
extern nvJitLinkResult __nvJitLinkDestroy_12_5 (nvJitLinkHandle *handle);
/**
 * \ingroup linking
...
{
  return __nvJitLinkDestroy_12_5 (handle);
}
#endif
 
extern nvJitLinkResult __nvJitLinkAddData_12_5(
  nvJitLinkHandle handle,
...
static inline nvJitLinkResult nvJitLinkAddData(
  ...
  const char *name) // name can be null
{
  return __nvJitLinkAddData_12_5 (handle, inputType, data, size, name);
}
#endif
 
extern nvJitLinkResult __nvJitLinkAddFile_12_5(
  nvJitLinkHandle handle,
  nvJitLinkInputType inputType,
...
static inline nvJitLinkResult nvJitLinkAddFile(
  ...
  const char *fileName) // includes path to file
{
  return __nvJitLinkAddFile_12_5 (handle, inputType, fileName);
}
#endif
 
extern nvJitLinkResult __nvJitLinkComplete_12_5 (nvJitLinkHandle handle);
/**
 * \ingroup linking
...
{
  return __nvJitLinkComplete_12_5 (handle);
}
#endif
 
extern nvJitLinkResult __nvJitLinkGetLinkedCubinSize_12_5(
  nvJitLinkHandle handle,
  size_t *size);
/**
 * \ingroup linking
...
static inline nvJitLinkResult nvJitLinkGetLinkedCubinSize(
  ...
  size_t *size)
{
  return __nvJitLinkGetLinkedCubinSize_12_5 (handle, size);
}
#endif

extern nvJitLinkResult __nvJitLinkGetLinkedCubin_12_5(
  nvJitLinkHandle handle,
  void *cubin);
/**
 * \ingroup linking
...
static inline nvJitLinkResult nvJitLinkGetLinkedCubin(
  ...
  void *cubin)
{
  return __nvJitLinkGetLinkedCubin_12_5 (handle, cubin);
}
#endif
 
extern nvJitLinkResult __nvJitLinkGetLinkedPtxSize_12_5(
  nvJitLinkHandle handle,
  size_t *size);
/**
 * \ingroup linking
...
static inline nvJitLinkResult nvJitLinkGetLinkedPtxSize(
  ...
  size_t *size)
{
  return __nvJitLinkGetLinkedPtxSize_12_5 (handle, size);
}
#endif

extern nvJitLinkResult __nvJitLinkGetLinkedPtx_12_5(
  nvJitLinkHandle handle,
  char *ptx);
/**
 * \ingroup linking
...
static inline nvJitLinkResult nvJitLinkGetLinkedPtx(
  ...
  char *ptx)
{
  return __nvJitLinkGetLinkedPtx_12_5 (handle, ptx);
}
#endif
 
extern nvJitLinkResult __nvJitLinkGetErrorLogSize_12_5(
  nvJitLinkHandle handle,
  size_t *size);
/**
 * \ingroup linking
...
static inline nvJitLinkResult nvJitLinkGetErrorLogSize(
  ...
  size_t *size)
{
  return __nvJitLinkGetErrorLogSize_12_5 (handle, size);
}
#endif

extern nvJitLinkResult __nvJitLinkGetErrorLog_12_5(
  nvJitLinkHandle handle,
  char *log);
/**
 * \ingroup linking
...
static inline nvJitLinkResult nvJitLinkGetErrorLog(
  ...
  char *log)
{
  return __nvJitLinkGetErrorLog_12_5 (handle, log);
}
#endif

extern nvJitLinkResult __nvJitLinkGetInfoLogSize_12_5(
  nvJitLinkHandle handle,
  size_t *size);
/**
 * \ingroup linking
...
static inline nvJitLinkResult nvJitLinkGetInfoLogSize(
  ...
  size_t *size)
{
  return __nvJitLinkGetInfoLogSize_12_5 (handle, size);
}
#endif

extern nvJitLinkResult __nvJitLinkGetInfoLog_12_5(
  nvJitLinkHandle handle,
  char *log);
/**
 * \ingroup linking
...
static inline nvJitLinkResult nvJitLinkGetInfoLog(
  ...
  char *log)
{
  return __nvJitLinkGetInfoLog_12_5 (handle, log);
}
#endif
