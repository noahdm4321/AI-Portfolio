...
class XlaCallModule {
 public:
  ...
  struct Attrs {
    ...
    ///
    /// Defaults to false
    TF_MUST_USE_RESULT Attrs UseShardyPartitioner(bool x) {
      Attrs ret = *this;
      ret.use_shardy_partitioner_ = x;
      return ret;
    }
  ...
  static Attrs UseShardyPartitioner(bool x) {
    return Attrs().UseShardyPartitioner(x);
  }
