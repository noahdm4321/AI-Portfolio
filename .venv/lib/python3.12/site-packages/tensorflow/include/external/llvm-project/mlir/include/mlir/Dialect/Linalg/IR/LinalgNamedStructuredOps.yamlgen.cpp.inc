  ...
  if (castIter != attrs.end()) {
    if (auto attr = llvm::dyn_cast<TypeFnAttr>(castIter->getValue()))
      castVal = attr.getValue();
              ...
              Value value1 = helper.buildTypeFn(castVal, block.getArgument(1).getType(), block.getArgument(0), emitError);
              if (!value1)
                return;
...
void ExpOp::regionBuilder(ImplicitLocOpBuilder &b,
  ...
  SmallVector<Value> yields;
              ...
              Value value1 = helper.buildUnaryFn(UnaryFn::exp, block.getArgument(0), emitError);
              if (!value1)
                return;
...
void LogOp::regionBuilder(ImplicitLocOpBuilder &b,
  ...
  SmallVector<Value> yields;
              ...
              Value value1 = helper.buildUnaryFn(UnaryFn::log, block.getArgument(0), emitError);
              if (!value1)
                return;
...
void AbsOp::regionBuilder(ImplicitLocOpBuilder &b,
  ...
  SmallVector<Value> yields;
              ...
              Value value1 = helper.buildUnaryFn(UnaryFn::abs, block.getArgument(0), emitError);
              if (!value1)
                return;
...
void CeilOp::regionBuilder(ImplicitLocOpBuilder &b,
  ...
  SmallVector<Value> yields;
              ...
              Value value1 = helper.buildUnaryFn(UnaryFn::ceil, block.getArgument(0), emitError);
              if (!value1)
                return;
...
void FloorOp::regionBuilder(ImplicitLocOpBuilder &b,
  ...
  SmallVector<Value> yields;
              ...
              Value value1 = helper.buildUnaryFn(UnaryFn::floor, block.getArgument(0), emitError);
              if (!value1)
                return;
...
void NegFOp::regionBuilder(ImplicitLocOpBuilder &b,
  ...
  SmallVector<Value> yields;
              ...
              Value value1 = helper.buildUnaryFn(UnaryFn::negf, block.getArgument(0), emitError);
              if (!value1)
                return;
...
void ReciprocalOp::regionBuilder(ImplicitLocOpBuilder &b,
  ...
  SmallVector<Value> yields;
              ...
              Value value1 = helper.buildUnaryFn(UnaryFn::reciprocal, block.getArgument(0), emitError);
              if (!value1)
                return;
...
void RoundOp::regionBuilder(ImplicitLocOpBuilder &b,
  ...
  SmallVector<Value> yields;
              ...
              Value value1 = helper.buildUnaryFn(UnaryFn::round, block.getArgument(0), emitError);
              if (!value1)
                return;
...
void SqrtOp::regionBuilder(ImplicitLocOpBuilder &b,
  ...
  SmallVector<Value> yields;
              ...
              Value value1 = helper.buildUnaryFn(UnaryFn::sqrt, block.getArgument(0), emitError);
              if (!value1)
                return;
...
void RsqrtOp::regionBuilder(ImplicitLocOpBuilder &b,
  ...
  SmallVector<Value> yields;
              ...
              Value value1 = helper.buildUnaryFn(UnaryFn::rsqrt, block.getArgument(0), emitError);
              if (!value1)
                return;
...
void SquareOp::regionBuilder(ImplicitLocOpBuilder &b,
  ...
  SmallVector<Value> yields;
              ...
              Value value1 = helper.buildUnaryFn(UnaryFn::square, block.getArgument(0), emitError);
              if (!value1)
                return;
...
void TanhOp::regionBuilder(ImplicitLocOpBuilder &b,
  ...
  SmallVector<Value> yields;
              ...
              Value value1 = helper.buildUnaryFn(UnaryFn::tanh, block.getArgument(0), emitError);
              if (!value1)
                return;
...
void ErfOp::regionBuilder(ImplicitLocOpBuilder &b,
  ...
  SmallVector<Value> yields;
              ...
              Value value1 = helper.buildUnaryFn(UnaryFn::erf, block.getArgument(0), emitError);
              if (!value1)
                return;
...
void AddOp::regionBuilder(ImplicitLocOpBuilder &b,
  ...
  SmallVector<Value> yields;
              ...
              Value value1 = helper.buildBinaryFn(BinaryFn::add, block.getArgument(0), block.getArgument(1), emitError);
              if (!value1)
                return;
...
void SubOp::regionBuilder(ImplicitLocOpBuilder &b,
  ...
  SmallVector<Value> yields;
              ...
              Value value1 = helper.buildBinaryFn(BinaryFn::sub, block.getArgument(0), block.getArgument(1), emitError);
              if (!value1)
                return;
...
void MulOp::regionBuilder(ImplicitLocOpBuilder &b,
  ...
  SmallVector<Value> yields;
              ...
              Value value1 = helper.buildBinaryFn(BinaryFn::mul, block.getArgument(0), block.getArgument(1), emitError);
              if (!value1)
                return;
...
void DivOp::regionBuilder(ImplicitLocOpBuilder &b,
  ...
  SmallVector<Value> yields;
              ...
              Value value1 = helper.buildBinaryFn(BinaryFn::div, block.getArgument(0), block.getArgument(1), emitError);
              if (!value1)
                return;
...
void DivUnsignedOp::regionBuilder(ImplicitLocOpBuilder &b,
  ...
  SmallVector<Value> yields;
              ...
              Value value1 = helper.buildBinaryFn(BinaryFn::div_unsigned, block.getArgument(0), block.getArgument(1), emitError);
              if (!value1)
                return;
...
void MaxOp::regionBuilder(ImplicitLocOpBuilder &b,
  ...
  SmallVector<Value> yields;
              ...
              Value value1 = helper.buildBinaryFn(BinaryFn::max_signed, block.getArgument(0), block.getArgument(1), emitError);
              if (!value1)
                return;
...
void MinOp::regionBuilder(ImplicitLocOpBuilder &b,
  ...
  SmallVector<Value> yields;
              ...
              Value value1 = helper.buildBinaryFn(BinaryFn::min_signed, block.getArgument(0), block.getArgument(1), emitError);
              if (!value1)
                return;
...
void PowFOp::regionBuilder(ImplicitLocOpBuilder &b,
  ...
  SmallVector<Value> yields;
              ...
              Value value1 = helper.buildBinaryFn(BinaryFn::powf, block.getArgument(0), block.getArgument(1), emitError);
              if (!value1)
                return;
...
void SelectOp::regionBuilder(ImplicitLocOpBuilder &b,
  ...
  SmallVector<Value> yields;
              ...
              Value value1 = helper.buildTernaryFn(TernaryFn::select, block.getArgument(0), block.getArgument(1), block.getArgument(2), emitError);
              if (!value1)
                return;
...
void QuantizedMatmulOp::regionBuilder(ImplicitLocOpBuilder &b,
  ...
  SmallVector<Value> yields;
              ...
              Value value1 = helper.buildTypeFn(TypeFn::cast_signed, block.getArgument(4).getType(), block.getArgument(0), emitError);
              if (!value1)
                return;
              
  
              Value value2 = helper.buildTypeFn(TypeFn::cast_signed, block.getArgument(4).getType(), block.getArgument(2), emitError);
              if (!value2)
                return;
              
  
              Value value3 = helper.buildBinaryFn(BinaryFn::sub, value1, value2, emitError);
              if (!value3)
                return;
              
  
              Value value4 = helper.buildTypeFn(TypeFn::cast_signed, block.getArgument(4).getType(), block.getArgument(1), emitError);
              if (!value4)
                return;
              
  
              Value value5 = helper.buildTypeFn(TypeFn::cast_signed, block.getArgument(4).getType(), block.getArgument(3), emitError);
              if (!value5)
                return;
              
  
              Value value6 = helper.buildBinaryFn(BinaryFn::sub, value4, value5, emitError);
              if (!value6)
                return;
              
  
              Value value7 = helper.buildBinaryFn(BinaryFn::mul, value3, value6, emitError);
              if (!value7)
                return;
              
  
              Value value8 = helper.buildBinaryFn(BinaryFn::add, block.getArgument(4), value7, emitError);
              if (!value8)
                return;
...
void Mmt4DOp::regionBuilder(ImplicitLocOpBuilder &b,
  ...
  SmallVector<Value> yields;
              ...
              Value value1 = helper.buildTypeFn(TypeFn::cast_signed, block.getArgument(2).getType(), block.getArgument(0), emitError);
              if (!value1)
                return;
              
  
              Value value2 = helper.buildTypeFn(TypeFn::cast_signed, block.getArgument(2).getType(), block.getArgument(1), emitError);
              if (!value2)
                return;
              ...
              Value value4 = helper.buildBinaryFn(BinaryFn::add, block.getArgument(2), value3, emitError);
              if (!value4)
                return;
...
ArrayAttr Conv3DNcdhwFcdhwOp::getIndexingMaps() {
  ...
  auto symbolBindings = getSymbolBindings(*this);
  SmallVector<AffineMap> maps;
  maps.push_back(llvm::cast<AffineMapAttr>(mlir::parseAttribute("affine_map<(d0, d1, d2, d3, d4, d5, d6, d7, d8)[s0, s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14] -> (d0, d5, d2 * s3 + d6 * s5, d3 * s7 + d7 * s9, d4 * s11 + d8 * s13)>", context)).getValue());
  maps.back() = simplifyAffineMap(maps.back().replaceDimsAndSymbols({}, symbolBindings, 9, 0));
  maps.push_back(llvm::cast<AffineMapAttr>(mlir::parseAttribute("affine_map<(d0, d1, d2, d3, d4, d5, d6, d7, d8)[s0, s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14] -> (d1, d5, d6, d7, d8)>", context)).getValue());
  maps.back() = simplifyAffineMap(maps.back().replaceDimsAndSymbols({}, symbolBindings, 9, 0));
  maps.push_back(llvm::cast<AffineMapAttr>(mlir::parseAttribute("affine_map<(d0, d1, d2, d3, d4, d5, d6, d7, d8)[s0, s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14] -> (d0, d1, d2, d3, d4)>", context)).getValue());
  maps.back() = simplifyAffineMap(maps.back().replaceDimsAndSymbols({}, symbolBindings, 9, 0));
  cached = Builder(context).getAffineMapArrayAttr(maps);
...
void PoolingNhwcSumOp::regionBuilder(ImplicitLocOpBuilder &b,
  ...
  SmallVector<Value> yields;
              ...
              Value value2 = helper.buildBinaryFn(BinaryFn::add, block.getArgument(2), value1, emitError);
              if (!value2)
                return;
...
void PoolingNhwcMaxOp::regionBuilder(ImplicitLocOpBuilder &b,
  ...
  SmallVector<Value> yields;
              ...
              Value value2 = helper.buildBinaryFn(BinaryFn::max_signed, block.getArgument(2), value1, emitError);
              if (!value2)
                return;
...
void PoolingNhwcMaxUnsignedOp::regionBuilder(ImplicitLocOpBuilder &b,
  ...
  SmallVector<Value> yields;
              ...
              Value value1 = helper.buildTypeFn(TypeFn::cast_unsigned, block.getArgument(2).getType(), block.getArgument(0), emitError);
              if (!value1)
                return;
              
  
              Value value2 = helper.buildBinaryFn(BinaryFn::max_unsigned, block.getArgument(2), value1, emitError);
              if (!value2)
                return;
...
void PoolingNhwcMinOp::regionBuilder(ImplicitLocOpBuilder &b,
  ...
  SmallVector<Value> yields;
              ...
              Value value2 = helper.buildBinaryFn(BinaryFn::min_signed, block.getArgument(2), value1, emitError);
              if (!value2)
                return;
...
void PoolingNhwcMinUnsignedOp::regionBuilder(ImplicitLocOpBuilder &b,
  ...
  SmallVector<Value> yields;
              ...
              Value value2 = helper.buildBinaryFn(BinaryFn::min_unsigned, block.getArgument(2), value1, emitError);
              if (!value2)
                return;
...
void FillOp::regionBuilder(ImplicitLocOpBuilder &b,
  ...
  yields.push_back(block.getArgument(0));
  helper.yieldOutputs(yields);
}
...
void FillRng2DOp::regionBuilder(ImplicitLocOpBuilder &b,
  ...
  Value value1 = helper.constant("2147483647 : i64");
              ...
              Value value2 = helper.buildTypeFn(TypeFn::cast_signed, helper.getFloat64Type(), value1, emitError);
              if (!value2)
                return;
              
  Value value3 = helper.index(1);
  
              Value value4 = helper.buildTypeFn(TypeFn::cast_signed, helper.getIntegerType(32), value3, emitError);
              if (!value4)
                return;
              
  Value value5 = helper.index(0);
  
              Value value6 = helper.buildTypeFn(TypeFn::cast_signed, helper.getIntegerType(32), value5, emitError);
              if (!value6)
                return;
              
  
              Value value7 = helper.buildBinaryFn(BinaryFn::add, value6, block.getArgument(2), emitError);
              if (!value7)
                return;
              
  Value value8 = helper.constant("1103515245 : i64");
  
              Value value9 = helper.buildTypeFn(TypeFn::cast_signed, helper.getIntegerType(32), value8, emitError);
              if (!value9)
                return;
              
  
              Value value10 = helper.buildBinaryFn(BinaryFn::mul, value7, value9, emitError);
              if (!value10)
                return;
              
  Value value11 = helper.constant("12345 : i64");
  
              Value value12 = helper.buildTypeFn(TypeFn::cast_signed, helper.getIntegerType(32), value11, emitError);
              if (!value12)
                return;
              
  
              Value value13 = helper.buildBinaryFn(BinaryFn::add, value10, value12, emitError);
              if (!value13)
                return;
              
  
              Value value14 = helper.buildBinaryFn(BinaryFn::add, value4, value13, emitError);
              if (!value14)
                return;
              
  Value value15 = helper.constant("1103515245 : i64");
  
              Value value16 = helper.buildTypeFn(TypeFn::cast_signed, helper.getIntegerType(32), value15, emitError);
              if (!value16)
                return;
              
  
              Value value17 = helper.buildBinaryFn(BinaryFn::mul, value14, value16, emitError);
              if (!value17)
                return;
              
  Value value18 = helper.constant("12345 : i64");
  
              Value value19 = helper.buildTypeFn(TypeFn::cast_signed, helper.getIntegerType(32), value18, emitError);
              if (!value19)
                return;
              
  
              Value value20 = helper.buildBinaryFn(BinaryFn::add, value17, value19, emitError);
              if (!value20)
                return;
              
  
              Value value21 = helper.buildTypeFn(TypeFn::cast_signed, helper.getFloat64Type(), value20, emitError);
              if (!value21)
                return;
              
  
              Value value22 = helper.buildBinaryFn(BinaryFn::add, value2, value21, emitError);
              if (!value22)
                return;
              
  
              Value value23 = helper.buildBinaryFn(BinaryFn::sub, block.getArgument(1), block.getArgument(0), emitError);
              if (!value23)
                return;
              
  Value value24 = helper.constant("2.3283063999999999E-10 : f64");
  
              Value value25 = helper.buildTypeFn(TypeFn::cast_signed, helper.getFloat64Type(), value24, emitError);
              if (!value25)
                return;
              
  
              Value value26 = helper.buildBinaryFn(BinaryFn::mul, value23, value25, emitError);
              if (!value26)
                return;
              
  
              Value value27 = helper.buildBinaryFn(BinaryFn::mul, value22, value26, emitError);
              if (!value27)
                return;
              
  
              Value value28 = helper.buildBinaryFn(BinaryFn::add, value27, block.getArgument(0), emitError);
              if (!value28)
                return;
              
  
              Value value29 = helper.buildTypeFn(TypeFn::cast_signed, block.getArgument(3).getType(), value28, emitError);
              if (!value29)
                return;
