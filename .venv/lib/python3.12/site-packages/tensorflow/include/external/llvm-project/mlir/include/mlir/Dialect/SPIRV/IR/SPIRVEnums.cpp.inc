...
::std::optional<Vendor> symbolizeVendor(uint32_t value) {
  ...
  case 3: return Vendor::Broadcom;
  case 4: return Vendor::Imagination;
  case 5: return Vendor::Intel;
  case 6: return Vendor::NVIDIA;
  case 7: return Vendor::Qualcomm;
  case 8: return Vendor::SwiftShader;
...
::llvm::StringRef stringifyExtension(Extension val) {
  switch (val) {
    ...
    case Extension::SPV_KHR_cooperative_matrix: return "SPV_KHR_cooperative_matrix";
    case Extension::SPV_KHR_bfloat16: return "SPV_KHR_bfloat16";
    ...
    case Extension::SPV_EXT_mesh_shader: return "SPV_EXT_mesh_shader";
    case Extension::SPV_EXT_replicated_composites: return "SPV_EXT_replicated_composites";
    case Extension::SPV_ARM_tensors: return "SPV_ARM_tensors";
    case Extension::SPV_ARM_graph: return "SPV_ARM_graph";
    ...
    case Extension::SPV_ALTERA_blocking_pipes: return "SPV_ALTERA_blocking_pipes";
    ...
    case Extension::SPV_INTEL_cache_controls: return "SPV_INTEL_cache_controls";
    case Extension::SPV_INTEL_tensor_float32_conversion: return "SPV_INTEL_tensor_float32_conversion";
...
::std::optional<Extension> symbolizeExtension(::llvm::StringRef str) {
  return ::llvm::StringSwitch<::std::optional<Extension>>(str)
      ...
      .Case("SPV_KHR_cooperative_matrix", Extension::SPV_KHR_cooperative_matrix)
      .Case("SPV_KHR_bfloat16", Extension::SPV_KHR_bfloat16)
      ...
      .Case("SPV_EXT_mesh_shader", Extension::SPV_EXT_mesh_shader)
      .Case("SPV_EXT_replicated_composites", Extension::SPV_EXT_replicated_composites)
      .Case("SPV_ARM_tensors", Extension::SPV_ARM_tensors)
      .Case("SPV_ARM_graph", Extension::SPV_ARM_graph)
      ...
      .Case("SPV_ALTERA_blocking_pipes", Extension::SPV_ALTERA_blocking_pipes)
      ...
      .Case("SPV_INTEL_cache_controls", Extension::SPV_INTEL_cache_controls)
      .Case("SPV_INTEL_tensor_float32_conversion", Extension::SPV_INTEL_tensor_float32_conversion)
...
::std::optional<Extension> symbolizeExtension(uint32_t value) {
  ...
  case 31: return Extension::SPV_KHR_cooperative_matrix;
  case 32: return Extension::SPV_KHR_bfloat16;
  ...
  case 1012: return Extension::SPV_EXT_mesh_shader;
  case 1013: return Extension::SPV_EXT_replicated_composites;
  case 6000: return Extension::SPV_ARM_tensors;
  case 6001: return Extension::SPV_ARM_graph;
  ...
  case 4022: return Extension::SPV_ALTERA_blocking_pipes;
  ...
  case 4032: return Extension::SPV_INTEL_cache_controls;
  case 4033: return Extension::SPV_INTEL_tensor_float32_conversion;
...
::llvm::StringRef stringifyCapability(Capability val) {
  switch (val) {
    ...
    case Capability::StorageTensorArrayDynamicIndexingEXT: return "StorageTensorArrayDynamicIndexingEXT";
    case Capability::StorageTensorArrayNonUniformIndexingEXT: return "StorageTensorArrayNonUniformIndexingEXT";
...
::std::optional<Capability> symbolizeCapability(::llvm::StringRef str) {
  return ::llvm::StringSwitch<::std::optional<Capability>>(str)
      ...
      .Case("MeshShadingEXT", Capability::MeshShadingEXT)
      ...
      .Case("BlockingPipesALTERA", Capability::BlockingPipesALTERA)
      ...
      .Case("CooperativeMatrixKHR", Capability::CooperativeMatrixKHR)
      .Case("ReplicatedCompositesEXT", Capability::ReplicatedCompositesEXT)
      ...
      .Case("TensorsARM", Capability::TensorsARM)
      .Case("StorageTensorArrayDynamicIndexingEXT", Capability::StorageTensorArrayDynamicIndexingEXT)
      .Case("StorageTensorArrayNonUniformIndexingEXT", Capability::StorageTensorArrayNonUniformIndexingEXT)
      .Case("GraphARM", Capability::GraphARM)
      ...
      .Case("CacheControlsINTEL", Capability::CacheControlsINTEL)
      .Case("BFloat16TypeKHR", Capability::BFloat16TypeKHR)
      .Case("BFloat16DotProductKHR", Capability::BFloat16DotProductKHR)
      .Case("BFloat16CooperativeMatrixKHR", Capability::BFloat16CooperativeMatrixKHR)
      .Case("TensorFloat32RoundingINTEL", Capability::TensorFloat32RoundingINTEL)
      .Default(::std::nullopt);
}
::std::optional<Capability> symbolizeCapability(uint32_t value) {
  ...
  case 5283: return Capability::MeshShadingEXT;
  ...
  case 5945: return Capability::BlockingPipesALTERA;
  ...
  case 6022: return Capability::CooperativeMatrixKHR;
  case 6024: return Capability::ReplicatedCompositesEXT;
  ...
  case 4174: return Capability::TensorsARM;
  case 4175: return Capability::StorageTensorArrayDynamicIndexingEXT;
  case 4176: return Capability::StorageTensorArrayNonUniformIndexingEXT;
  case 4191: return Capability::GraphARM;
  ...
  case 6441: return Capability::CacheControlsINTEL;
  case 5116: return Capability::BFloat16TypeKHR;
  case 5117: return Capability::BFloat16DotProductKHR;
  case 5118: return Capability::BFloat16CooperativeMatrixKHR;
  case 6425: return Capability::TensorFloat32RoundingINTEL;
  default: return ::std::nullopt;
  }
}
...
::std::optional<BuiltIn> symbolizeBuiltIn(::llvm::StringRef str) {
  return ::llvm::StringSwitch<::std::optional<BuiltIn>>(str)
      ...
      .Case("PrimitivePointIndicesEXT", BuiltIn::PrimitivePointIndicesEXT)
      .Case("PrimitiveLineIndicesEXT", BuiltIn::PrimitiveLineIndicesEXT)
      .Case("PrimitiveTriangleIndicesEXT", BuiltIn::PrimitiveTriangleIndicesEXT)
      .Case("CullPrimitiveEXT", BuiltIn::CullPrimitiveEXT)
...
::std::optional<BuiltIn> symbolizeBuiltIn(uint32_t value) {
  ...
  case 5294: return BuiltIn::PrimitivePointIndicesEXT;
  case 5295: return BuiltIn::PrimitiveLineIndicesEXT;
  case 5296: return BuiltIn::PrimitiveTriangleIndicesEXT;
  case 5299: return BuiltIn::CullPrimitiveEXT;
...
::std::optional<Decoration> symbolizeDecoration(::llvm::StringRef str) {
  return ::llvm::StringSwitch<::std::optional<Decoration>>(str)
      ...
      .Case("PerPrimitiveEXT", Decoration::PerPrimitiveEXT)
      ...
      .Case("CacheControlLoadINTEL", Decoration::CacheControlLoadINTEL)
      .Case("CacheControlStoreINTEL", Decoration::CacheControlStoreINTEL)
      .Default(::std::nullopt);
}
::std::optional<Decoration> symbolizeDecoration(uint32_t value) {
  ...
  case 5271: return Decoration::PerPrimitiveEXT;
  ...
  case 6442: return Decoration::CacheControlLoadINTEL;
  case 6443: return Decoration::CacheControlStoreINTEL;
  default: return ::std::nullopt;
  }
}
...
::std::optional<ExecutionMode> symbolizeExecutionMode(::llvm::StringRef str) {
  return ::llvm::StringSwitch<::std::optional<ExecutionMode>>(str)
      ...
      .Case("OutputLinesEXT", ExecutionMode::OutputLinesEXT)
      .Case("OutputPrimitivesEXT", ExecutionMode::OutputPrimitivesEXT)
      ...
      .Case("OutputTrianglesEXT", ExecutionMode::OutputTrianglesEXT)
...
::std::optional<ExecutionMode> symbolizeExecutionMode(uint32_t value) {
  ...
  case 5269: return ExecutionMode::OutputLinesEXT;
  case 5270: return ExecutionMode::OutputPrimitivesEXT;
  case 5289: return ExecutionMode::DerivativeGroupQuadsNV;
  case 5290: return ExecutionMode::DerivativeGroupLinearNV;
  case 5298: return ExecutionMode::OutputTrianglesEXT;
...
::std::optional<ExecutionModel> symbolizeExecutionModel(::llvm::StringRef str) {
  return ::llvm::StringSwitch<::std::optional<ExecutionModel>>(str)
      ...
      .Case("TaskEXT", ExecutionModel::TaskEXT)
      .Case("MeshEXT", ExecutionModel::MeshEXT)
      .Default(::std::nullopt);
}
::std::optional<ExecutionModel> symbolizeExecutionModel(uint32_t value) {
  ...
  case 5364: return ExecutionModel::TaskEXT;
  case 5365: return ExecutionModel::MeshEXT;
  default: return ::std::nullopt;
  }
}
...
::llvm::StringRef stringifyFPEncoding(FPEncoding val) {
  switch (val) {
...
::std::optional<FPEncoding> symbolizeFPEncoding(::llvm::StringRef str) {
  return ::llvm::StringSwitch<::std::optional<FPEncoding>>(str)
      .Case("BFloat16KHR", FPEncoding::BFloat16KHR)
      .Default(::std::nullopt);
}
::std::optional<FPEncoding> symbolizeFPEncoding(uint32_t value) {
  switch (value) {
  case 0: return FPEncoding::BFloat16KHR;
  default: return ::std::nullopt;
  }
}
...
::std::optional<FPRoundingMode> symbolizeFPRoundingMode(::llvm::StringRef str) {
  return ::llvm::StringSwitch<::std::optional<FPRoundingMode>>(str)
      .Case("RTE", FPRoundingMode::RTE)
      .Case("RTZ", FPRoundingMode::RTZ)
      .Case("RTP", FPRoundingMode::RTP)
      .Case("RTN", FPRoundingMode::RTN)
      .Default(::std::nullopt);
}
::std::optional<FPRoundingMode> symbolizeFPRoundingMode(uint32_t value) {
  switch (value) {
  case 0: return FPRoundingMode::RTE;
  case 1: return FPRoundingMode::RTZ;
  case 2: return FPRoundingMode::RTP;
  case 3: return FPRoundingMode::RTN;
  default: return ::std::nullopt;
  }
}
...
::std::optional<StorageClass> symbolizeStorageClass(::llvm::StringRef str) {
  return ::llvm::StringSwitch<::std::optional<StorageClass>>(str)
      ...
      .Case("TaskPayloadWorkgroupEXT", StorageClass::TaskPayloadWorkgroupEXT)
...
::std::optional<StorageClass> symbolizeStorageClass(uint32_t value) {
  ...
  case 5402: return StorageClass::TaskPayloadWorkgroupEXT;
...
::llvm::StringRef stringifyCooperativeMatrixUseKHR(CooperativeMatrixUseKHR val) {
  switch (val) {
    case CooperativeMatrixUseKHR::MatrixA: return "MatrixA";
    case CooperativeMatrixUseKHR::MatrixB: return "MatrixB";
    case CooperativeMatrixUseKHR::MatrixAcc: return "MatrixAcc";
  }
  return "";
}

::std::optional<CooperativeMatrixUseKHR> symbolizeCooperativeMatrixUseKHR(::llvm::StringRef str) {
  return ::llvm::StringSwitch<::std::optional<CooperativeMatrixUseKHR>>(str)
      .Case("MatrixA", CooperativeMatrixUseKHR::MatrixA)
      .Case("MatrixB", CooperativeMatrixUseKHR::MatrixB)
      .Case("MatrixAcc", CooperativeMatrixUseKHR::MatrixAcc)
      .Default(::std::nullopt);
}
::std::optional<CooperativeMatrixUseKHR> symbolizeCooperativeMatrixUseKHR(uint32_t value) {
  switch (value) {
  case 0: return CooperativeMatrixUseKHR::MatrixA;
  case 1: return CooperativeMatrixUseKHR::MatrixB;
  case 2: return CooperativeMatrixUseKHR::MatrixAcc;
  default: return ::std::nullopt;
  }
}
...
::llvm::StringRef stringifyCooperativeMatrixLayoutKHR(CooperativeMatrixLayoutKHR val) {
  switch (val) {
    case CooperativeMatrixLayoutKHR::RowMajor: return "RowMajor";
    case CooperativeMatrixLayoutKHR::ColumnMajor: return "ColumnMajor";
  }
  return "";
}

::std::optional<CooperativeMatrixLayoutKHR> symbolizeCooperativeMatrixLayoutKHR(::llvm::StringRef str) {
  return ::llvm::StringSwitch<::std::optional<CooperativeMatrixLayoutKHR>>(str)
      .Case("RowMajor", CooperativeMatrixLayoutKHR::RowMajor)
      .Case("ColumnMajor", CooperativeMatrixLayoutKHR::ColumnMajor)
      .Default(::std::nullopt);
}
::std::optional<CooperativeMatrixLayoutKHR> symbolizeCooperativeMatrixLayoutKHR(uint32_t value) {
  switch (value) {
  case 0: return CooperativeMatrixLayoutKHR::RowMajor;
  case 1: return CooperativeMatrixLayoutKHR::ColumnMajor;
  default: return ::std::nullopt;
  }
}
...
std::string stringifyCooperativeMatrixOperandsKHR(CooperativeMatrixOperandsKHR symbol) {
  ...
  if (1u == (1u & val))
    strs.push_back("ASigned");

  if (2u == (2u & val))
    strs.push_back("BSigned");

  if (4u == (4u & val))
    strs.push_back("CSigned");

  if (8u == (8u & val))
    strs.push_back("ResultSigned");

  if (16u == (16u & val))
    strs.push_back("AccSat");
  return ::llvm::join(strs, "|");
}

::std::optional<CooperativeMatrixOperandsKHR> symbolizeCooperativeMatrixOperandsKHR(::llvm::StringRef str) {
  // Special case for all bits unset.
  if (str == "None") return CooperativeMatrixOperandsKHR::None;
  ...
  return static_cast<CooperativeMatrixOperandsKHR>(val);
}

::std::optional<CooperativeMatrixOperandsKHR> symbolizeCooperativeMatrixOperandsKHR(uint32_t value) {
  // Special case for all bits unset.
  if (value == 0) return CooperativeMatrixOperandsKHR::None;

  if (value & ~static_cast<uint32_t>(31u)) return std::nullopt;
  return static_cast<CooperativeMatrixOperandsKHR>(value);
}
...
::llvm::StringRef stringifyLoadCacheControl(LoadCacheControl val) {
  switch (val) {
    case LoadCacheControl::Uncached: return "Uncached";
    case LoadCacheControl::Cached: return "Cached";
    case LoadCacheControl::Streaming: return "Streaming";
    case LoadCacheControl::InvalidateAfterR: return "InvalidateAfterR";
    case LoadCacheControl::ConstCached: return "ConstCached";
  }
  return "";
}
...
::std::optional<LoadCacheControl> symbolizeLoadCacheControl(::llvm::StringRef str) {
  return ::llvm::StringSwitch<::std::optional<LoadCacheControl>>(str)
      .Case("Uncached", LoadCacheControl::Uncached)
      .Case("Cached", LoadCacheControl::Cached)
      .Case("Streaming", LoadCacheControl::Streaming)
      .Case("InvalidateAfterR", LoadCacheControl::InvalidateAfterR)
      .Case("ConstCached", LoadCacheControl::ConstCached)
      .Default(::std::nullopt);
}
::std::optional<LoadCacheControl> symbolizeLoadCacheControl(uint32_t value) {
  switch (value) {
  case 0: return LoadCacheControl::Uncached;
  case 1: return LoadCacheControl::Cached;
  case 2: return LoadCacheControl::Streaming;
  case 3: return LoadCacheControl::InvalidateAfterR;
  case 4: return LoadCacheControl::ConstCached;
  default: return ::std::nullopt;
  }
}
...
::llvm::StringRef stringifyStoreCacheControl(StoreCacheControl val) {
  switch (val) {
    case StoreCacheControl::Uncached: return "Uncached";
    case StoreCacheControl::WriteThrough: return "WriteThrough";
    case StoreCacheControl::WriteBack: return "WriteBack";
    case StoreCacheControl::Streaming: return "Streaming";
  }
  return "";
}
...
::std::optional<StoreCacheControl> symbolizeStoreCacheControl(::llvm::StringRef str) {
  return ::llvm::StringSwitch<::std::optional<StoreCacheControl>>(str)
      .Case("Uncached", StoreCacheControl::Uncached)
      .Case("WriteThrough", StoreCacheControl::WriteThrough)
      .Case("WriteBack", StoreCacheControl::WriteBack)
      .Case("Streaming", StoreCacheControl::Streaming)
      .Default(::std::nullopt);
}
::std::optional<StoreCacheControl> symbolizeStoreCacheControl(uint32_t value) {
  switch (value) {
  case 0: return StoreCacheControl::Uncached;
  case 1: return StoreCacheControl::WriteThrough;
  case 2: return StoreCacheControl::WriteBack;
  case 3: return StoreCacheControl::Streaming;
  default: return ::std::nullopt;
  }
}
...
::llvm::StringRef stringifyOpcode(Opcode val) {
  switch (val) {
    ...
    case Opcode::OpImageSampleImplicitLod: return "OpImageSampleImplicitLod";
    case Opcode::OpImageSampleExplicitLod: return "OpImageSampleExplicitLod";
    case Opcode::OpImageSampleProjDrefImplicitLod: return "OpImageSampleProjDrefImplicitLod";
    case Opcode::OpImageFetch: return "OpImageFetch";
    case Opcode::OpImageDrefGather: return "OpImageDrefGather";
    case Opcode::OpImageRead: return "OpImageRead";
    case Opcode::OpImageWrite: return "OpImageWrite";
    ...
    case Opcode::OpConvertPtrToU: return "OpConvertPtrToU";
    case Opcode::OpConvertUToPtr: return "OpConvertUToPtr";
    ...
    case Opcode::OpVectorTimesMatrix: return "OpVectorTimesMatrix";
    case Opcode::OpMatrixTimesVector: return "OpMatrixTimesVector";
    case Opcode::OpMatrixTimesMatrix: return "OpMatrixTimesMatrix";
    case Opcode::OpDot: return "OpDot";
    ...
    case Opcode::OpIsFinite: return "OpIsFinite";
    ...
    case Opcode::OpEmitVertex: return "OpEmitVertex";
    case Opcode::OpEndPrimitive: return "OpEndPrimitive";
    ...
    case Opcode::OpSwitch: return "OpSwitch";
    case Opcode::OpKill: return "OpKill";
    ...
    case Opcode::OpGroupNonUniformAll: return "OpGroupNonUniformAll";
    case Opcode::OpGroupNonUniformAny: return "OpGroupNonUniformAny";
    case Opcode::OpGroupNonUniformAllEqual: return "OpGroupNonUniformAllEqual";
    ...
    case Opcode::OpGroupNonUniformBallotBitCount: return "OpGroupNonUniformBallotBitCount";
    case Opcode::OpGroupNonUniformBallotFindLSB: return "OpGroupNonUniformBallotFindLSB";
    case Opcode::OpGroupNonUniformBallotFindMSB: return "OpGroupNonUniformBallotFindMSB";
    ...
    case Opcode::OpGroupNonUniformBitwiseAnd: return "OpGroupNonUniformBitwiseAnd";
    case Opcode::OpGroupNonUniformBitwiseOr: return "OpGroupNonUniformBitwiseOr";
    case Opcode::OpGroupNonUniformBitwiseXor: return "OpGroupNonUniformBitwiseXor";
    case Opcode::OpGroupNonUniformLogicalAnd: return "OpGroupNonUniformLogicalAnd";
    case Opcode::OpGroupNonUniformLogicalOr: return "OpGroupNonUniformLogicalOr";
    case Opcode::OpGroupNonUniformLogicalXor: return "OpGroupNonUniformLogicalXor";
    case Opcode::OpGroupNonUniformQuadSwap: return "OpGroupNonUniformQuadSwap";
    case Opcode::OpTypeTensorARM: return "OpTypeTensorARM";
    case Opcode::OpGraphEntryPointARM: return "OpGraphEntryPointARM";
    case Opcode::OpGraphARM: return "OpGraphARM";
    case Opcode::OpGraphInputARM: return "OpGraphInputARM";
    case Opcode::OpGraphSetOutputARM: return "OpGraphSetOutputARM";
    case Opcode::OpGraphEndARM: return "OpGraphEndARM";
    case Opcode::OpTypeGraphARM: return "OpTypeGraphARM";
    case Opcode::OpGraphConstantARM: return "OpGraphConstantARM";
    case Opcode::OpSubgroupBallotKHR: return "OpSubgroupBallotKHR";
    case Opcode::OpGroupNonUniformRotateKHR: return "OpGroupNonUniformRotateKHR";
    ...
    case Opcode::OpTypeCooperativeMatrixKHR: return "OpTypeCooperativeMatrixKHR";
    case Opcode::OpCooperativeMatrixLoadKHR: return "OpCooperativeMatrixLoadKHR";
    case Opcode::OpCooperativeMatrixStoreKHR: return "OpCooperativeMatrixStoreKHR";
    case Opcode::OpCooperativeMatrixMulAddKHR: return "OpCooperativeMatrixMulAddKHR";
    case Opcode::OpCooperativeMatrixLengthKHR: return "OpCooperativeMatrixLengthKHR";
    case Opcode::OpConstantCompositeReplicateEXT: return "OpConstantCompositeReplicateEXT";
    case Opcode::OpSpecConstantCompositeReplicateEXT: return "OpSpecConstantCompositeReplicateEXT";
    case Opcode::OpEmitMeshTasksEXT: return "OpEmitMeshTasksEXT";
    case Opcode::OpSetMeshOutputsEXT: return "OpSetMeshOutputsEXT";
    ...
    case Opcode::OpControlBarrierArriveINTEL: return "OpControlBarrierArriveINTEL";
    case Opcode::OpControlBarrierWaitINTEL: return "OpControlBarrierWaitINTEL";
    case Opcode::OpGroupIMulKHR: return "OpGroupIMulKHR";
    case Opcode::OpGroupFMulKHR: return "OpGroupFMulKHR";
    case Opcode::OpRoundFToTF32INTEL: return "OpRoundFToTF32INTEL";
  }
  return "";
}
...
::std::optional<Opcode> symbolizeOpcode(::llvm::StringRef str) {
  return ::llvm::StringSwitch<::std::optional<Opcode>>(str)
      ...
      .Case("OpImageSampleImplicitLod", Opcode::OpImageSampleImplicitLod)
      .Case("OpImageSampleExplicitLod", Opcode::OpImageSampleExplicitLod)
      .Case("OpImageSampleProjDrefImplicitLod", Opcode::OpImageSampleProjDrefImplicitLod)
      .Case("OpImageFetch", Opcode::OpImageFetch)
      .Case("OpImageDrefGather", Opcode::OpImageDrefGather)
      .Case("OpImageRead", Opcode::OpImageRead)
      .Case("OpImageWrite", Opcode::OpImageWrite)
      ...
      .Case("OpConvertPtrToU", Opcode::OpConvertPtrToU)
      .Case("OpConvertUToPtr", Opcode::OpConvertUToPtr)
      ...
      .Case("OpVectorTimesMatrix", Opcode::OpVectorTimesMatrix)
      .Case("OpMatrixTimesVector", Opcode::OpMatrixTimesVector)
      .Case("OpMatrixTimesMatrix", Opcode::OpMatrixTimesMatrix)
      .Case("OpDot", Opcode::OpDot)
      ...
      .Case("OpIsFinite", Opcode::OpIsFinite)
      ...
      .Case("OpEmitVertex", Opcode::OpEmitVertex)
      .Case("OpEndPrimitive", Opcode::OpEndPrimitive)
      ...
      .Case("OpSwitch", Opcode::OpSwitch)
      .Case("OpKill", Opcode::OpKill)
      ...
      .Case("OpGroupNonUniformAll", Opcode::OpGroupNonUniformAll)
      .Case("OpGroupNonUniformAny", Opcode::OpGroupNonUniformAny)
      .Case("OpGroupNonUniformAllEqual", Opcode::OpGroupNonUniformAllEqual)
      ...
      .Case("OpGroupNonUniformBallotBitCount", Opcode::OpGroupNonUniformBallotBitCount)
      .Case("OpGroupNonUniformBallotFindLSB", Opcode::OpGroupNonUniformBallotFindLSB)
      .Case("OpGroupNonUniformBallotFindMSB", Opcode::OpGroupNonUniformBallotFindMSB)
      ...
      .Case("OpGroupNonUniformBitwiseAnd", Opcode::OpGroupNonUniformBitwiseAnd)
      .Case("OpGroupNonUniformBitwiseOr", Opcode::OpGroupNonUniformBitwiseOr)
      .Case("OpGroupNonUniformBitwiseXor", Opcode::OpGroupNonUniformBitwiseXor)
      .Case("OpGroupNonUniformLogicalAnd", Opcode::OpGroupNonUniformLogicalAnd)
      .Case("OpGroupNonUniformLogicalOr", Opcode::OpGroupNonUniformLogicalOr)
      .Case("OpGroupNonUniformLogicalXor", Opcode::OpGroupNonUniformLogicalXor)
      .Case("OpGroupNonUniformQuadSwap", Opcode::OpGroupNonUniformQuadSwap)
      .Case("OpTypeTensorARM", Opcode::OpTypeTensorARM)
      .Case("OpGraphEntryPointARM", Opcode::OpGraphEntryPointARM)
      .Case("OpGraphARM", Opcode::OpGraphARM)
      .Case("OpGraphInputARM", Opcode::OpGraphInputARM)
      .Case("OpGraphSetOutputARM", Opcode::OpGraphSetOutputARM)
      .Case("OpGraphEndARM", Opcode::OpGraphEndARM)
      .Case("OpTypeGraphARM", Opcode::OpTypeGraphARM)
      .Case("OpGraphConstantARM", Opcode::OpGraphConstantARM)
      .Case("OpSubgroupBallotKHR", Opcode::OpSubgroupBallotKHR)
      .Case("OpGroupNonUniformRotateKHR", Opcode::OpGroupNonUniformRotateKHR)
      ...
      .Case("OpTypeCooperativeMatrixKHR", Opcode::OpTypeCooperativeMatrixKHR)
      .Case("OpCooperativeMatrixLoadKHR", Opcode::OpCooperativeMatrixLoadKHR)
      .Case("OpCooperativeMatrixStoreKHR", Opcode::OpCooperativeMatrixStoreKHR)
      .Case("OpCooperativeMatrixMulAddKHR", Opcode::OpCooperativeMatrixMulAddKHR)
      .Case("OpCooperativeMatrixLengthKHR", Opcode::OpCooperativeMatrixLengthKHR)
      .Case("OpConstantCompositeReplicateEXT", Opcode::OpConstantCompositeReplicateEXT)
      .Case("OpSpecConstantCompositeReplicateEXT", Opcode::OpSpecConstantCompositeReplicateEXT)
      .Case("OpEmitMeshTasksEXT", Opcode::OpEmitMeshTasksEXT)
      .Case("OpSetMeshOutputsEXT", Opcode::OpSetMeshOutputsEXT)
      ...
      .Case("OpControlBarrierArriveINTEL", Opcode::OpControlBarrierArriveINTEL)
      .Case("OpControlBarrierWaitINTEL", Opcode::OpControlBarrierWaitINTEL)
      .Case("OpGroupIMulKHR", Opcode::OpGroupIMulKHR)
      .Case("OpGroupFMulKHR", Opcode::OpGroupFMulKHR)
      .Case("OpRoundFToTF32INTEL", Opcode::OpRoundFToTF32INTEL)
      .Default(::std::nullopt);
}
::std::optional<Opcode> symbolizeOpcode(uint32_t value) {
  ...
  case 87: return Opcode::OpImageSampleImplicitLod;
  case 88: return Opcode::OpImageSampleExplicitLod;
  case 93: return Opcode::OpImageSampleProjDrefImplicitLod;
  case 95: return Opcode::OpImageFetch;
  case 97: return Opcode::OpImageDrefGather;
  case 98: return Opcode::OpImageRead;
  case 99: return Opcode::OpImageWrite;
  ...
  case 117: return Opcode::OpConvertPtrToU;
  case 120: return Opcode::OpConvertUToPtr;
  ...
  case 144: return Opcode::OpVectorTimesMatrix;
  case 145: return Opcode::OpMatrixTimesVector;
  case 146: return Opcode::OpMatrixTimesMatrix;
  case 148: return Opcode::OpDot;
  ...
  case 158: return Opcode::OpIsFinite;
  ...
  case 218: return Opcode::OpEmitVertex;
  case 219: return Opcode::OpEndPrimitive;
  ...
  case 251: return Opcode::OpSwitch;
  case 252: return Opcode::OpKill;
  ...
  case 334: return Opcode::OpGroupNonUniformAll;
  case 335: return Opcode::OpGroupNonUniformAny;
  case 336: return Opcode::OpGroupNonUniformAllEqual;
  case 337: return Opcode::OpGroupNonUniformBroadcast;
  case 339: return Opcode::OpGroupNonUniformBallot;
  case 342: return Opcode::OpGroupNonUniformBallotBitCount;
  case 343: return Opcode::OpGroupNonUniformBallotFindLSB;
  case 344: return Opcode::OpGroupNonUniformBallotFindMSB;
  ...
  case 359: return Opcode::OpGroupNonUniformBitwiseAnd;
  case 360: return Opcode::OpGroupNonUniformBitwiseOr;
  case 361: return Opcode::OpGroupNonUniformBitwiseXor;
  case 362: return Opcode::OpGroupNonUniformLogicalAnd;
  case 363: return Opcode::OpGroupNonUniformLogicalOr;
  case 364: return Opcode::OpGroupNonUniformLogicalXor;
  case 366: return Opcode::OpGroupNonUniformQuadSwap;
  case 4163: return Opcode::OpTypeTensorARM;
  case 4182: return Opcode::OpGraphEntryPointARM;
  case 4183: return Opcode::OpGraphARM;
  case 4184: return Opcode::OpGraphInputARM;
  case 4185: return Opcode::OpGraphSetOutputARM;
  case 4186: return Opcode::OpGraphEndARM;
  case 4190: return Opcode::OpTypeGraphARM;
  case 4181: return Opcode::OpGraphConstantARM;
  case 4421: return Opcode::OpSubgroupBallotKHR;
  case 4431: return Opcode::OpGroupNonUniformRotateKHR;
  ...
  case 4456: return Opcode::OpTypeCooperativeMatrixKHR;
  case 4457: return Opcode::OpCooperativeMatrixLoadKHR;
  case 4458: return Opcode::OpCooperativeMatrixStoreKHR;
  case 4459: return Opcode::OpCooperativeMatrixMulAddKHR;
  case 4460: return Opcode::OpCooperativeMatrixLengthKHR;
  case 4461: return Opcode::OpConstantCompositeReplicateEXT;
  case 4462: return Opcode::OpSpecConstantCompositeReplicateEXT;
  case 5294: return Opcode::OpEmitMeshTasksEXT;
  case 5295: return Opcode::OpSetMeshOutputsEXT;
  ...
  case 6142: return Opcode::OpControlBarrierArriveINTEL;
  case 6143: return Opcode::OpControlBarrierWaitINTEL;
  case 6401: return Opcode::OpGroupIMulKHR;
  case 6402: return Opcode::OpGroupFMulKHR;
  case 6426: return Opcode::OpRoundFToTF32INTEL;
  default: return ::std::nullopt;
  }
}
...
std::string stringifyFPFastMathMode(FPFastMathMode symbol) {
  auto val = static_cast<uint32_t>(symbol);
  assert(196639u == (196639u | val) && "invalid bits set in bit enum");
  // Special case for all bits unset.
  if (val == 0) return "None";
  ...
  if (1u == (1u & val))
    strs.push_back("NotNaN");

  if (2u == (2u & val))
    strs.push_back("NotInf");

  if (4u == (4u & val))
    strs.push_back("NSZ");

  if (8u == (8u & val))
    strs.push_back("AllowRecip");

  if (16u == (16u & val))
    strs.push_back("Fast");

  if (65536u == (65536u & val))
    strs.push_back("AllowContractFastINTEL");

  if (131072u == (131072u & val))
    strs.push_back("AllowReassocINTEL");
  return ::llvm::join(strs, "|");
}

::std::optional<FPFastMathMode> symbolizeFPFastMathMode(::llvm::StringRef str) {
  // Special case for all bits unset.
  if (str == "None") return FPFastMathMode::None;
  ...
  for (auto symbol : symbols) {
    auto bit = llvm::StringSwitch<::std::optional<uint32_t>>(symbol.trim())
      ...
      .Case("AllowRecip", 8)
      .Case("Fast", 16)
      .Case("AllowContractFastINTEL", 65536)
      .Case("AllowReassocINTEL", 131072)
      .Default(::std::nullopt);
    if (bit) { val |= *bit; } else { return ::std::nullopt; }
  }
  return static_cast<FPFastMathMode>(val);
}

::std::optional<FPFastMathMode> symbolizeFPFastMathMode(uint32_t value) {
  // Special case for all bits unset.
  if (value == 0) return FPFastMathMode::None;

  if (value & ~static_cast<uint32_t>(196639u)) return std::nullopt;
  return static_cast<FPFastMathMode>(value);
}

} // namespace mlir::spirv
namespace mlir::spirv {

::llvm::StringRef stringifyTosaExtAccType(TosaExtAccType val) {
  switch (val) {
    case TosaExtAccType::INT32: return "INT32";
    case TosaExtAccType::FP16: return "FP16";
    case TosaExtAccType::FP32: return "FP32";
    case TosaExtAccType::INT48: return "INT48";
  }
  return "";
}

::std::optional<TosaExtAccType> symbolizeTosaExtAccType(::llvm::StringRef str) {
  return ::llvm::StringSwitch<::std::optional<TosaExtAccType>>(str)
      .Case("INT32", TosaExtAccType::INT32)
      .Case("FP16", TosaExtAccType::FP16)
      .Case("FP32", TosaExtAccType::FP32)
      .Case("INT48", TosaExtAccType::INT48)
      .Default(::std::nullopt);
}
::std::optional<TosaExtAccType> symbolizeTosaExtAccType(uint32_t value) {
  switch (value) {
  case 1: return TosaExtAccType::INT32;
  case 2: return TosaExtAccType::FP16;
  case 3: return TosaExtAccType::FP32;
  case 4: return TosaExtAccType::INT48;
  default: return ::std::nullopt;
  }
}
...
::llvm::StringRef stringifyTosaExtNaNPropagationModeType(TosaExtNaNPropagationModeType val) {
  switch (val) {
    case TosaExtNaNPropagationModeType::Propagate: return "Propagate";
    case TosaExtNaNPropagationModeType::Ignore: return "Ignore";
  }
  return "";
}

::std::optional<TosaExtNaNPropagationModeType> symbolizeTosaExtNaNPropagationModeType(::llvm::StringRef str) {
  return ::llvm::StringSwitch<::std::optional<TosaExtNaNPropagationModeType>>(str)
      .Case("Propagate", TosaExtNaNPropagationModeType::Propagate)
      .Case("Ignore", TosaExtNaNPropagationModeType::Ignore)
      .Default(::std::nullopt);
}
::std::optional<TosaExtNaNPropagationModeType> symbolizeTosaExtNaNPropagationModeType(uint32_t value) {
  switch (value) {
  case 1: return TosaExtNaNPropagationModeType::Propagate;
  case 2: return TosaExtNaNPropagationModeType::Ignore;
  default: return ::std::nullopt;
  }
}
