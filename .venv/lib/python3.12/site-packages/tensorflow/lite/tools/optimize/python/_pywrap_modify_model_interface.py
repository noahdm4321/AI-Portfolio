...
def __try_import():
  imports_paths = ["litert.python._pywrap_modify_model_interface", "tensorflow.lite.python._pywrap_modify_model_interface", "tensorflow._pywrap_modify_model_interface", "tensorflow.python._pywrap_modify_model_interface"] # template_val
  exceptions = []
  last_exception = None
