...
def __try_import():
  imports_paths = ["litert.python.format_converter_wrapper_pybind11", "tensorflow.lite.python.format_converter_wrapper_pybind11", "tensorflow.format_converter_wrapper_pybind11", "tensorflow.python.format_converter_wrapper_pybind11"] # template_val
  exceptions = []
  last_exception = None
