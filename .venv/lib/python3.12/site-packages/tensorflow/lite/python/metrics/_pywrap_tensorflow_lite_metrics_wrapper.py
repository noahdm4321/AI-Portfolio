...
def __try_import():
  imports_paths = ["litert.python._pywrap_tensorflow_lite_metrics_wrapper", "tensorflow.lite.python._pywrap_tensorflow_lite_metrics_wrapper", "tensorflow._pywrap_tensorflow_lite_metrics_wrapper", "tensorflow.python._pywrap_tensorflow_lite_metrics_wrapper"] # template_val
  exceptions = []
  last_exception = None
