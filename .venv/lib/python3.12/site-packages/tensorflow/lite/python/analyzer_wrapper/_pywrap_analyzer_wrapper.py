...
def __try_import():
  imports_paths = ["litert.python._pywrap_analyzer_wrapper", "tensorflow.lite.python._pywrap_analyzer_wrapper", "tensorflow._pywrap_analyzer_wrapper", "tensorflow.python._pywrap_analyzer_wrapper"] # template_val
  exceptions = []
  last_exception = None
