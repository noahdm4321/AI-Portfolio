...
class EnvironmentT(object):
    ...
    def __init__(
        ...
        self.tensorflowVersion = tensorflowVersion  # type: Optional[str]
        self.apiVersion = apiVersion  # type: int
        self.modelType = modelType  # type: int
        self.modelHash = modelHash  # type: int
...
class ConversionOptionsT(object):
    ...
    def __init__(
        self,
        modelOptimizationModes = None,
        allowCustomOps = False,
        enableSelectTfOps = False,
        forceSelectTfOps = False,
        sparsityBlockSizes = None,
    ):
        self.modelOptimizationModes = modelOptimizationModes  # type: Optional[List[int]]
        self.allowCustomOps = allowCustomOps  # type: bool
        self.enableSelectTfOps = enableSelectTfOps  # type: bool
        self.forceSelectTfOps = forceSelectTfOps  # type: bool
        self.sparsityBlockSizes = sparsityBlockSizes  # type: Optional[List[SparsityBlockSizeT]]
...
class ConversionMetadataT(object):
    ...
    def __init__(
        ...
        self.environment = environment  # type: Optional[EnvironmentT]
        self.options = options  # type: Optional[ConversionOptionsT]
