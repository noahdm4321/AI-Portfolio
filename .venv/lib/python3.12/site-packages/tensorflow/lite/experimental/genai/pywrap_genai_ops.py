...
def __try_import():
  imports_paths = ["litert.python.pywrap_genai_ops", "tensorflow.lite.python.pywrap_genai_ops", "tensorflow.pywrap_genai_ops", "tensorflow.python.pywrap_genai_ops"] # template_val
  exceptions = []
  last_exception = None
